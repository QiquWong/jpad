...
nPoints = 30;
myMachVector = transpose(linspace(0, 0.97, nPoints));
...
hdfFileName = 'BPR8_MaximumCruiseThrust_Mach_Altitude.h5';
...
h5create(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/data', size(myData'));
h5write(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/data', myData');

h5create(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/var_0', size(myAltitudeVector_FT'));
h5write(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/var_0', myAltitudeVector_FT');

h5create(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/var_1', size(myMachVector'));
h5write(hdfFileName, '/BPR8_MaximumCruiseThrust_Mach_Altitude/var_1', myMachVector');
