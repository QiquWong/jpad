...
public class Geometry extends AuxiliaryComponentCalculator{
	...
	public Geometry(Airfoil airfoil,  AircraftEnum aircraftName, AirfoilStationEnum station) {	
		...
		_maximumThicknessOverChord = 0.18;
		_thicknessOverChordUnit = 0.18; 
		_radiusLE = 0.01; 
		_deltaYPercent =3.;
		_anglePhiTE = Amount.valueOf(0,SI.RADIAN); 
		_twist = Amount.valueOf(0.0,SI.RADIAN);
		...
		break;
			case KINK:	
				...
				_deltaYPercent =3.;
				_anglePhiTE = Amount.valueOf(0,SI.RADIAN); 
				_twist = Amount.valueOf(-0.6,SI.RADIAN);
			...
			case TIP:	
				...
				_maximumThicknessOverChord = 0.14;
				_thicknessOverChordUnit = 0.14; 
				_radiusLE = 0.01; 
				_deltaYPercent =3.;
				_anglePhiTE = Amount.valueOf(0,SI.RADIAN); 
				_twist = Amount.valueOf(-2.0,SI.RADIAN);
