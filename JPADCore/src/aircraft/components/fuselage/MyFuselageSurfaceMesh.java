...
public class MyFuselageSurfaceMesh {
	...
	public MyFuselageSurfaceMesh(Fuselage fuselage) {

		_theFuselage = fuselage;
		
		// EXPERIMENTAL
		MyLineMeshYZ lineMesh = new MyLineMeshYZ(
				_theFuselage,                          // the fuselage object 
				_theFuselage.get_sectionsYZ().get(3),  // the section XY
				_theFuselage.get_len_N(),              // the X-coordinate
