...
public class MyLineMeshYZ {

	private Fuselage _theFuselage;
	private MyFuselageCurvesSection _theCurvesSection;
	...
	public MyLineMeshYZ(
			Fuselage fuselage, 
			MyFuselageCurvesSection curvesSection, 
		    Amount<Length> x, 
			int ni_Sec) 
	{
...
//		System.out.println("theta: "+vTheta.size());
	...
	public MyFuselageCurvesSection get_CurvesSection() {
		return _theCurvesSection;
	}

	public void set_CurvesSection(MyFuselageCurvesSection _theCurvesSection) {
