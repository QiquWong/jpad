...
public class MyFuselageCurvesUpperView {
	...
	public MyFuselageCurvesUpperView(
...
//		Double dyTail               = _half_w_B - ratioWidthTailLength*(_l_T - dxTail); // TODO: why?!
	...
	public MyFuselageCurvesUpperView(Double l_N, Double h_N, Double l_C, Double l_F, Double half_w_B) {
		this(
