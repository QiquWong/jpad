...
public class MyFuselageCurvesSideView {
...
//	float deltaU = (float) (1.0/(_nPoints-1));
	...
	public MyFuselageCurvesSideView(
	...
	public MyFuselageCurvesSideView(Double l_N, Double h_N, Double l_C, Double l_F,Double h_T, Double half_d_C,Double a) {
		this(
