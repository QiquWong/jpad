...
public class MyFuselageCurvesSection {
	...
	public MyFuselageCurvesSection(
	...
	public MyFuselageCurvesSection(Double w_B, Double h_B, Double a, Double rhoUpper, Double rhoLower)
	{
		this(
	...
	// Utility function
	public MyFuselageCurvesSection translateZ(double dZ)
	{
		// NOTE: x ==> Y+, left side of fuselage section when seen from X- to X+
		// NOTE: y ==> Z+, top side of fuselage section when seen from X- to X+
