...
//					System.out.println(" alpha local airfoil " + alphaLocalAirfoil);
	...
	public class MeanAirfoil { //Behind ADAS p39
		...
		public Airfoil calculateMeanAirfoil (LiftingSurface2Panels theWing){
	...
	public static Airfoil calculateIntermediateAirfoil (LiftingSurface2Panels theWing, double yLoc){
