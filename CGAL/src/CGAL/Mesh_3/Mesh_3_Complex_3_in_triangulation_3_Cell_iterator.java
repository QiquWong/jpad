...
public class Mesh_3_Complex_3_in_triangulation_3_Cell_iterator implements   Iterable<Mesh_3_regular_triangulation_3_Cell_handle>, Iterator<Mesh_3_regular_triangulation_3_Cell_handle>  {
  ...
  public Mesh_3_Complex_3_in_triangulation_3_Cell_iterator clone() {
    return new Mesh_3_Complex_3_in_triangulation_3_Cell_iterator(CGAL_Mesh_3JNI.Mesh_3_Complex_3_in_triangulation_3_Cell_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Mesh_3_Complex_3_in_triangulation_3_Cell_iterator other) {
    CGAL_Mesh_3JNI.Mesh_3_Complex_3_in_triangulation_3_Cell_iterator_clone__SWIG_1(swigCPtr, this, Mesh_3_Complex_3_in_triangulation_3_Cell_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Mesh_3_Complex_3_in_triangulation_3_Cell_iterator p) {
    return CGAL_Mesh_3JNI.Mesh_3_Complex_3_in_triangulation_3_Cell_iterator_equals(swigCPtr, this, Mesh_3_Complex_3_in_triangulation_3_Cell_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Mesh_3_Complex_3_in_triangulation_3_Cell_iterator p) {
    return CGAL_Mesh_3JNI.Mesh_3_Complex_3_in_triangulation_3_Cell_iterator_not_equals(swigCPtr, this, Mesh_3_Complex_3_in_triangulation_3_Cell_iterator.getCPtr(p), p);
  }
