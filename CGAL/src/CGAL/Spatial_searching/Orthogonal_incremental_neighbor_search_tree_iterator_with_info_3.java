...
public class Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3 implements   Iterable<Point_with_info_3>, Iterator<Point_with_info_3>  {
  ...
  public Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3 clone() {
    return new Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3(CGAL_Spatial_searchingJNI.Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3 other) {
    CGAL_Spatial_searchingJNI.Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3_clone__SWIG_1(swigCPtr, this, Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3.getCPtr(other), other);
  }
  ...
  public boolean equals(Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3 p) {
    return CGAL_Spatial_searchingJNI.Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3_equals(swigCPtr, this, Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3.getCPtr(p), p);
  }

  public boolean not_equals(Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3 p) {
    return CGAL_Spatial_searchingJNI.Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3_not_equals(swigCPtr, this, Orthogonal_incremental_neighbor_search_tree_iterator_with_info_3.getCPtr(p), p);
  }
