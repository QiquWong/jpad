...
public class Surface_mesh_default_triangulation_3_Edge_iterator implements   Iterable<Surface_mesh_default_triangulation_3_Edge>, Iterator<Surface_mesh_default_triangulation_3_Edge>  {
  ...
  public Surface_mesh_default_triangulation_3_Edge_iterator clone() {
    return new Surface_mesh_default_triangulation_3_Edge_iterator(CGAL_Surface_mesherJNI.Surface_mesh_default_triangulation_3_Edge_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Surface_mesh_default_triangulation_3_Edge_iterator other) {
    CGAL_Surface_mesherJNI.Surface_mesh_default_triangulation_3_Edge_iterator_clone__SWIG_1(swigCPtr, this, Surface_mesh_default_triangulation_3_Edge_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Surface_mesh_default_triangulation_3_Edge_iterator p) {
    return CGAL_Surface_mesherJNI.Surface_mesh_default_triangulation_3_Edge_iterator_equals(swigCPtr, this, Surface_mesh_default_triangulation_3_Edge_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Surface_mesh_default_triangulation_3_Edge_iterator p) {
    return CGAL_Surface_mesherJNI.Surface_mesh_default_triangulation_3_Edge_iterator_not_equals(swigCPtr, this, Surface_mesh_default_triangulation_3_Edge_iterator.getCPtr(p), p);
  }
