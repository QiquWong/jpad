...
public class Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator implements   Iterable<Mesh_2_Constrained_Delaunay_triangulation_2_Vertex_handle>, Iterator<Mesh_2_Constrained_Delaunay_triangulation_2_Vertex_handle>  {
  ...
  public Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator clone() {
    return new Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator(CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator other) {
    CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator_clone__SWIG_1(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator p) {
    return CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator_equals(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator p) {
    return CGAL_Mesh_2JNI.Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator_not_equals(swigCPtr, this, Mesh_2_Constrained_Delaunay_triangulation_2_Finite_vertices_iterator.getCPtr(p), p);
  }
