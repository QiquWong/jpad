...
public class Weighted_alpha_shape_2_Hidden_vertices_iterator implements   Iterable<Weighted_alpha_shape_2_Vertex_handle>, Iterator<Weighted_alpha_shape_2_Vertex_handle>  {
  ...
  public Weighted_alpha_shape_2_Hidden_vertices_iterator clone() {
    return new Weighted_alpha_shape_2_Hidden_vertices_iterator(CGAL_Alpha_shape_2JNI.Weighted_alpha_shape_2_Hidden_vertices_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Weighted_alpha_shape_2_Hidden_vertices_iterator other) {
    CGAL_Alpha_shape_2JNI.Weighted_alpha_shape_2_Hidden_vertices_iterator_clone__SWIG_1(swigCPtr, this, Weighted_alpha_shape_2_Hidden_vertices_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Weighted_alpha_shape_2_Hidden_vertices_iterator p) {
    return CGAL_Alpha_shape_2JNI.Weighted_alpha_shape_2_Hidden_vertices_iterator_equals(swigCPtr, this, Weighted_alpha_shape_2_Hidden_vertices_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Weighted_alpha_shape_2_Hidden_vertices_iterator p) {
    return CGAL_Alpha_shape_2JNI.Weighted_alpha_shape_2_Hidden_vertices_iterator_not_equals(swigCPtr, this, Weighted_alpha_shape_2_Hidden_vertices_iterator.getCPtr(p), p);
  }
