...
public class Triangulation_2_All_faces_iterator implements   Iterable<Triangulation_2_Face_handle>, Iterator<Triangulation_2_Face_handle>  {
  ...
  public Triangulation_2_All_faces_iterator clone() {
    return new Triangulation_2_All_faces_iterator(CGAL_Triangulation_2JNI.Triangulation_2_All_faces_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Triangulation_2_All_faces_iterator other) {
    CGAL_Triangulation_2JNI.Triangulation_2_All_faces_iterator_clone__SWIG_1(swigCPtr, this, Triangulation_2_All_faces_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Triangulation_2_All_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Triangulation_2_All_faces_iterator_equals(swigCPtr, this, Triangulation_2_All_faces_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Triangulation_2_All_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Triangulation_2_All_faces_iterator_not_equals(swigCPtr, this, Triangulation_2_All_faces_iterator.getCPtr(p), p);
  }
