...
public class Constrained_Delaunay_triangulation_plus_2_Vertex_handle {
  ...
  public boolean lt(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_lt(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public boolean gt(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_gt(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public boolean le(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_le(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public boolean ge(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_ge(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public boolean equals(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public boolean not_equals(Constrained_Delaunay_triangulation_plus_2_Vertex_handle p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_not_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_handle.getCPtr(p), p);
  }

  public int hashCode() {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_handle_hashCode(swigCPtr, this);
  }
