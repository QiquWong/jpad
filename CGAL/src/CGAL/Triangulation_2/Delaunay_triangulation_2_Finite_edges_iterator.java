...
public class Delaunay_triangulation_2_Finite_edges_iterator implements   Iterable<Delaunay_triangulation_2_Edge>, Iterator<Delaunay_triangulation_2_Edge>  {
  ...
  public Delaunay_triangulation_2_Finite_edges_iterator clone() {
    return new Delaunay_triangulation_2_Finite_edges_iterator(CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Finite_edges_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Delaunay_triangulation_2_Finite_edges_iterator other) {
    CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Finite_edges_iterator_clone__SWIG_1(swigCPtr, this, Delaunay_triangulation_2_Finite_edges_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Delaunay_triangulation_2_Finite_edges_iterator p) {
    return CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Finite_edges_iterator_equals(swigCPtr, this, Delaunay_triangulation_2_Finite_edges_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Delaunay_triangulation_2_Finite_edges_iterator p) {
    return CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Finite_edges_iterator_not_equals(swigCPtr, this, Delaunay_triangulation_2_Finite_edges_iterator.getCPtr(p), p);
  }
