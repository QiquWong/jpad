...
public class Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator implements   Iterable<Constrained_Delaunay_triangulation_plus_2_Face_handle>, Iterator<Constrained_Delaunay_triangulation_plus_2_Face_handle>  {
  ...
  public Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator clone() {
    return new Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator(CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator other) {
    CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator_clone__SWIG_1(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator_not_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Finite_faces_iterator.getCPtr(p), p);
  }
