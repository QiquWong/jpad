...
public class Constrained_Delaunay_triangulation_plus_2_Vertex_circulator implements   Iterable<Constrained_Delaunay_triangulation_plus_2_Vertex_handle>, Iterator<Constrained_Delaunay_triangulation_plus_2_Vertex_handle>  {
  ...
  public Constrained_Delaunay_triangulation_plus_2_Vertex_circulator clone() {
    return new Constrained_Delaunay_triangulation_plus_2_Vertex_circulator(CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_circulator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Constrained_Delaunay_triangulation_plus_2_Vertex_circulator other) {
    CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_circulator_clone__SWIG_1(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_circulator.getCPtr(other), other);
  }
  ...
  public boolean equals(Constrained_Delaunay_triangulation_plus_2_Vertex_circulator p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_circulator_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_circulator.getCPtr(p), p);
  }

  public boolean not_equals(Constrained_Delaunay_triangulation_plus_2_Vertex_circulator p) {
    return CGAL_Triangulation_2JNI.Constrained_Delaunay_triangulation_plus_2_Vertex_circulator_not_equals(swigCPtr, this, Constrained_Delaunay_triangulation_plus_2_Vertex_circulator.getCPtr(p), p);
  }
