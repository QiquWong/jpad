...
public class Regular_triangulation_2_All_faces_iterator implements   Iterable<Regular_triangulation_2_Face_handle>, Iterator<Regular_triangulation_2_Face_handle>  {
  ...
  public Regular_triangulation_2_All_faces_iterator clone() {
    return new Regular_triangulation_2_All_faces_iterator(CGAL_Triangulation_2JNI.Regular_triangulation_2_All_faces_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Regular_triangulation_2_All_faces_iterator other) {
    CGAL_Triangulation_2JNI.Regular_triangulation_2_All_faces_iterator_clone__SWIG_1(swigCPtr, this, Regular_triangulation_2_All_faces_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Regular_triangulation_2_All_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Regular_triangulation_2_All_faces_iterator_equals(swigCPtr, this, Regular_triangulation_2_All_faces_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Regular_triangulation_2_All_faces_iterator p) {
    return CGAL_Triangulation_2JNI.Regular_triangulation_2_All_faces_iterator_not_equals(swigCPtr, this, Regular_triangulation_2_All_faces_iterator.getCPtr(p), p);
  }
