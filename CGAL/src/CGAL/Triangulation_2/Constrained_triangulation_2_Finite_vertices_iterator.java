...
public class Constrained_triangulation_2_Finite_vertices_iterator implements   Iterable<Constrained_triangulation_2_Vertex_handle>, Iterator<Constrained_triangulation_2_Vertex_handle>  {
  ...
  public Constrained_triangulation_2_Finite_vertices_iterator clone() {
    return new Constrained_triangulation_2_Finite_vertices_iterator(CGAL_Triangulation_2JNI.Constrained_triangulation_2_Finite_vertices_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Constrained_triangulation_2_Finite_vertices_iterator other) {
    CGAL_Triangulation_2JNI.Constrained_triangulation_2_Finite_vertices_iterator_clone__SWIG_1(swigCPtr, this, Constrained_triangulation_2_Finite_vertices_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Constrained_triangulation_2_Finite_vertices_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_triangulation_2_Finite_vertices_iterator_equals(swigCPtr, this, Constrained_triangulation_2_Finite_vertices_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Constrained_triangulation_2_Finite_vertices_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_triangulation_2_Finite_vertices_iterator_not_equals(swigCPtr, this, Constrained_triangulation_2_Finite_vertices_iterator.getCPtr(p), p);
  }
