...
public class Constrained_triangulation_2_All_edges_iterator implements   Iterable<Constrained_triangulation_2_Edge>, Iterator<Constrained_triangulation_2_Edge>  {
  ...
  public Constrained_triangulation_2_All_edges_iterator clone() {
    return new Constrained_triangulation_2_All_edges_iterator(CGAL_Triangulation_2JNI.Constrained_triangulation_2_All_edges_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Constrained_triangulation_2_All_edges_iterator other) {
    CGAL_Triangulation_2JNI.Constrained_triangulation_2_All_edges_iterator_clone__SWIG_1(swigCPtr, this, Constrained_triangulation_2_All_edges_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Constrained_triangulation_2_All_edges_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_triangulation_2_All_edges_iterator_equals(swigCPtr, this, Constrained_triangulation_2_All_edges_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Constrained_triangulation_2_All_edges_iterator p) {
    return CGAL_Triangulation_2JNI.Constrained_triangulation_2_All_edges_iterator_not_equals(swigCPtr, this, Constrained_triangulation_2_All_edges_iterator.getCPtr(p), p);
  }
