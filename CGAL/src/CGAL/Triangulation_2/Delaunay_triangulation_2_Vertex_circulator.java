...
public class Delaunay_triangulation_2_Vertex_circulator implements   Iterable<Delaunay_triangulation_2_Vertex_handle>, Iterator<Delaunay_triangulation_2_Vertex_handle>  {
  ...
  public Delaunay_triangulation_2_Vertex_circulator clone() {
    return new Delaunay_triangulation_2_Vertex_circulator(CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Vertex_circulator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Delaunay_triangulation_2_Vertex_circulator other) {
    CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Vertex_circulator_clone__SWIG_1(swigCPtr, this, Delaunay_triangulation_2_Vertex_circulator.getCPtr(other), other);
  }
  ...
  public boolean equals(Delaunay_triangulation_2_Vertex_circulator p) {
    return CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Vertex_circulator_equals(swigCPtr, this, Delaunay_triangulation_2_Vertex_circulator.getCPtr(p), p);
  }

  public boolean not_equals(Delaunay_triangulation_2_Vertex_circulator p) {
    return CGAL_Triangulation_2JNI.Delaunay_triangulation_2_Vertex_circulator_not_equals(swigCPtr, this, Delaunay_triangulation_2_Vertex_circulator.getCPtr(p), p);
  }
