...
public class Polygon_2_Vertex_iterator implements   Iterable<Point_2>, Iterator<Point_2>  {
  ...
  public Polygon_2_Vertex_iterator clone() {
    return new Polygon_2_Vertex_iterator(CGAL_KernelJNI.Polygon_2_Vertex_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Polygon_2_Vertex_iterator other) {
    CGAL_KernelJNI.Polygon_2_Vertex_iterator_clone__SWIG_1(swigCPtr, this, Polygon_2_Vertex_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Polygon_2_Vertex_iterator p) {
    return CGAL_KernelJNI.Polygon_2_Vertex_iterator_equals(swigCPtr, this, Polygon_2_Vertex_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Polygon_2_Vertex_iterator p) {
    return CGAL_KernelJNI.Polygon_2_Vertex_iterator_not_equals(swigCPtr, this, Polygon_2_Vertex_iterator.getCPtr(p), p);
  }
