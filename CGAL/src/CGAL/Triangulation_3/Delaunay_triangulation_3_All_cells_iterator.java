...
public class Delaunay_triangulation_3_All_cells_iterator implements   Iterable<Delaunay_triangulation_3_Cell_handle>, Iterator<Delaunay_triangulation_3_Cell_handle>  {
  ...
  public Delaunay_triangulation_3_All_cells_iterator clone() {
    return new Delaunay_triangulation_3_All_cells_iterator(CGAL_Triangulation_3JNI.Delaunay_triangulation_3_All_cells_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Delaunay_triangulation_3_All_cells_iterator other) {
    CGAL_Triangulation_3JNI.Delaunay_triangulation_3_All_cells_iterator_clone__SWIG_1(swigCPtr, this, Delaunay_triangulation_3_All_cells_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Delaunay_triangulation_3_All_cells_iterator p) {
    return CGAL_Triangulation_3JNI.Delaunay_triangulation_3_All_cells_iterator_equals(swigCPtr, this, Delaunay_triangulation_3_All_cells_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Delaunay_triangulation_3_All_cells_iterator p) {
    return CGAL_Triangulation_3JNI.Delaunay_triangulation_3_All_cells_iterator_not_equals(swigCPtr, this, Delaunay_triangulation_3_All_cells_iterator.getCPtr(p), p);
  }
