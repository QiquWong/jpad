...
public class Regular_triangulation_3_All_facets_iterator implements   Iterable<Regular_triangulation_3_Facet>, Iterator<Regular_triangulation_3_Facet>  {
  ...
  public Regular_triangulation_3_All_facets_iterator clone() {
    return new Regular_triangulation_3_All_facets_iterator(CGAL_Triangulation_3JNI.Regular_triangulation_3_All_facets_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Regular_triangulation_3_All_facets_iterator other) {
    CGAL_Triangulation_3JNI.Regular_triangulation_3_All_facets_iterator_clone__SWIG_1(swigCPtr, this, Regular_triangulation_3_All_facets_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Regular_triangulation_3_All_facets_iterator p) {
    return CGAL_Triangulation_3JNI.Regular_triangulation_3_All_facets_iterator_equals(swigCPtr, this, Regular_triangulation_3_All_facets_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Regular_triangulation_3_All_facets_iterator p) {
    return CGAL_Triangulation_3JNI.Regular_triangulation_3_All_facets_iterator_not_equals(swigCPtr, this, Regular_triangulation_3_All_facets_iterator.getCPtr(p), p);
  }
