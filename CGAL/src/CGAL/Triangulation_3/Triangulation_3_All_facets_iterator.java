...
public class Triangulation_3_All_facets_iterator implements   Iterable<Triangulation_3_Facet>, Iterator<Triangulation_3_Facet>  {
  ...
  public Triangulation_3_All_facets_iterator clone() {
    return new Triangulation_3_All_facets_iterator(CGAL_Triangulation_3JNI.Triangulation_3_All_facets_iterator_clone__SWIG_0(swigCPtr, this), true);
  }

  public void clone(Triangulation_3_All_facets_iterator other) {
    CGAL_Triangulation_3JNI.Triangulation_3_All_facets_iterator_clone__SWIG_1(swigCPtr, this, Triangulation_3_All_facets_iterator.getCPtr(other), other);
  }
  ...
  public boolean equals(Triangulation_3_All_facets_iterator p) {
    return CGAL_Triangulation_3JNI.Triangulation_3_All_facets_iterator_equals(swigCPtr, this, Triangulation_3_All_facets_iterator.getCPtr(p), p);
  }

  public boolean not_equals(Triangulation_3_All_facets_iterator p) {
    return CGAL_Triangulation_3JNI.Triangulation_3_All_facets_iterator_not_equals(swigCPtr, this, Triangulation_3_All_facets_iterator.getCPtr(p), p);
  }
