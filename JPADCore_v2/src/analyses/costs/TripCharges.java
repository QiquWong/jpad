...
public class TripCharges {
	...
	public void initialize(Aircraft aircraft, ACCostsManager costs) {
		initialize(costs.getLandingFeesPerTon(), 
				aircraft.getTheAnalysisManager().getTheWeights().getMaximumTakeOffMass(), 
				aircraft.getTheAnalysisManager().getBlockTime(),
				aircraft.getTheAnalysisManager().getReferenceRange(), costs.getJenkinsonNavigationalCharges(),
				aircraft.getTheAnalysisManager().getTheWeights().getPaxMassMax(), aircraft.getCabinConfiguration().getMaxPax().intValue(),
				costs.getGroundHandlingCostXPax(),
				aircraft.getTheAnalysisManager().getTheWeights().getManufacturerEmptyMass().minus(aircraft.getPowerPlant().getTotalMass()),
				costs.getManHourLaborRate(), costs.getAirframeCost(), 
				aircraft.getTheAnalysisManager().getFlightTime(),
				...
				aircraft.getTheAnalysisManager().getVOptimumCruise(), costs.getAircraftCost(),
