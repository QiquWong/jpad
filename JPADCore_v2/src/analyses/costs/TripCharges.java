...
public class TripCharges {
	...
	public void initialize(Aircraft aircraft, ACCostsManager costs) {
		initialize(costs.getLandingFeesPerTon(), 
				...
				aircraft.getTheWeights().getPaxMassMax(), aircraft.getCabinConfiguration().getMaxPax().intValue(),
				costs.getGroundHandlingCostXPax(),
				aircraft.getTheWeights().getManufacturerEmptyMass().minus(aircraft.getPowerPlant().getTotalMass()),
				...
				aircraft.getTheWeights().getOperatingEmptyMass(), 
