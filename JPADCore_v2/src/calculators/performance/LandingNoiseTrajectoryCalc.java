...
//	private Amount<Velocity> vSLanding, vApproach, vFlare, vWind, vTouchDown;
//	private Amount<Length> wingToGroundDistance, obstacle;
//	private Amount<Angle> gammaDescent, iw;
...
//	private Double kAlphaDot, kcLMax, kRot, cLmaxLND, kGround, alphaDotInitial, deltaCD0LandingGear, deltaCD0OEI, 
...
//										LandingNoiseTrajectoryCalc.this.getThePowerPlant().getEngineList().get(0).getT0().doubleValue(SI.NEWTON),
//										LandingNoiseTrajectoryCalc.this.getThePowerPlant().getEngineNumber(),
//										LandingNoiseTrajectoryCalc.this.getPhi(),
//										LandingNoiseTrajectoryCalc.this.getThePowerPlant().getEngineList().get(0).getBPR(),
//										LandingNoiseTrajectoryCalc.this.getThePowerPlant().getEngineType(),
...
//												x[3],
//												x[1] + 
//												(LandingNoiseTrajectoryCalc.this.getvWind().getEstimatedValue()*Math.cos(Amount.valueOf(
//														x[2],
...
//						/////////////////////////////////////////////////////////////////////////////
//						LandingNoiseTrajectoryCalc.this.setPhiCutback(Math.max(phiCutback1, phiCutback2));
//						System.out.println("\n\tThrottle setting for cutback trajectory = " + LandingNoiseTrajectoryCalc.this.getPhiCutback());
//					}
//					if(cutback == true && phiCutback != null) {
//						LandingNoiseTrajectoryCalc.this.setPhiCutback(phiCutback);
//						System.out.println("\n\tThrottle setting for cutback trajectory = " + LandingNoiseTrajectoryCalc.this.getPhiCutback());
//					}
...
//									}, 
//							new double[] {1, LandingNoiseTrajectoryCalc.this.getPhiCutback()}
//							);
//					System.out.println("\n---------------------------DONE!-------------------------------\n");
//					return Action.CONTINUE;
//				}
...
//					//----------------------------------------------------------------------------------------
//					// CL:				
//					LandingNoiseTrajectoryCalc.this.getcL().add(
//							((DynamicsEquationsNoiseTrajectory)ode).cL(
//									x[1],
//									((DynamicsEquationsNoiseTrajectory)ode).alpha,
//									x[2],
...
//					//----------------------------------------------------------------------------------------
//					// WEIGHT:
//					LandingNoiseTrajectoryCalc.this.getWeight().add(
...
//							(LandingNoiseTrajectoryCalc.this.getLoadFactor().get(LandingNoiseTrajectoryCalc.this.getLoadFactor().size()-1) > 1) &&
//							(LandingNoiseTrajectoryCalc.this.getLoadFactor().get(LandingNoiseTrajectoryCalc.this.getLoadFactor().size()-2) < 1)) {
...
//							(LandingNoiseTrajectoryCalc.this.getcL().get(LandingNoiseTrajectoryCalc.this.getcL().size()-1) - (kcLMax*cLmaxTO) >= 0.0) &&
//							((LandingNoiseTrajectoryCalc.this.getcL().get(LandingNoiseTrajectoryCalc.this.getcL().size()-2) - (kcLMax*cLmaxTO)) < 0.0)) {
//						System.out.println("\n\t\tBEGIN BAR HOLDING");
//						System.out.println(
...
//							(LandingNoiseTrajectoryCalc.this.getAcceleration().get(LandingNoiseTrajectoryCalc.this.getAcceleration().size()-1).doubleValue(SI.METERS_PER_SQUARE_SECOND)< 0.0) &&
//							(LandingNoiseTrajectoryCalc.this.getAcceleration().get(LandingNoiseTrajectoryCalc.this.getAcceleration().size()-2).doubleValue(SI.METERS_PER_SQUARE_SECOND) > 0.0)
//							) {
//						
...
//					manageOutputData(1.0, LandingNoiseTrajectoryCalc.this.getPhiCutback(), timeHistories);
//				else if(cutback==true && phiCutback!=null)
...
//							alphaDot.add(
//									LandingNoiseTrajectoryCalc.this.getAlphaDotInitial()
//									*(1-(LandingNoiseTrajectoryCalc.this.getkAlphaDot()
//											*alphaFunction.value(times.get(i).doubleValue(SI.SECOND))
//											)
//											)
//									);
...
//									0.0, null, 0.0, null,
//									"Time", "Speed", "s", "m/s",
//									currentOutputFolder, "Speed_evolution_SI");
//
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
...
//									0.0, null, null, null,
//									"Time", "Speed", "s", "kn",
//									currentOutputFolder, "Speed_evolution_IMPERIAL");
//
//						//.................................................................................
...
//									currentOutputFolder, "Speed_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "Speed_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
...
//									currentOutputFolder, "Acceleration_evolution_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(timeMap.get(phi)),
...
//									currentOutputFolder, "Acceleration_evolution_IMPERIAL");
//
//						//.................................................................................
...
//									currentOutputFolder, "Acceleration_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "Acceleration_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
...
//								0.0, null, 0.0, null,
//								"Time", "Load Factor", "s", "",
//								currentOutputFolder, "LoadFactor_evolution");
//
//						//.................................................................................
...
//									currentOutputFolder, "LoadFactor_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "LoadFactor_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
...
//									currentOutputFolder, "RateOfClimb_evolution_SI");
//						
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(timeMap.get(phi)),
...
//									currentOutputFolder, "RateOfClimb_evolution_IMPERIAL");
//
//						//.................................................................................
...
//									currentOutputFolder, "RateOfClimb_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "RateOfClimb_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
//						// CL v.s. Time
//						MyChartToFileUtils.plotNoLegend(
...
//								0.0, null, 0.0, null,
//								"Time", "CL", "s", "",
//								currentOutputFolder, "CL_evolution");
//
//						//.................................................................................
...
//									currentOutputFolder, "CL_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "CL_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
//						// CD v.s. Time
//						MyChartToFileUtils.plotNoLegend(
...
//								0.0, null, 0.0, null,
//								"Time", "CD", "s", "",
//								currentOutputFolder, "CD_evolution");
//
//						//.................................................................................
...
//									currentOutputFolder, "CD_vs_GroundDistance_SI");
//
//						if(unitFormat == UnitFormatEnum.IMPERIAL)
//							MyChartToFileUtils.plotNoLegend(
//									MyArrayUtils.convertListOfAmountTodoubleArray(
...
//									currentOutputFolder, "CD_vs_GroundDistance_IMPERIAL");
//
//						//.................................................................................
...
//			this.weight = LandingNoiseTrajectoryCalc.this.getMaxLandingMass()
...
//									LandingNoiseTrajectoryCalc.this.getPolarCLTakeOff(),
//									LandingNoiseTrajectoryCalc.this.getPolarCDTakeOff(),
//									LandingNoiseTrajectoryCalc.this.getAspectRatio())
//							);
//			
...
//
//				double cL0 = LandingNoiseTrajectoryCalc.this.cL0;
//				double cLalpha = LandingNoiseTrajectoryCalc.this.getcLalphaFlap().to(NonSI.DEGREE_ANGLE.inverse()).getEstimatedValue();
...
//				alphaDot = LandingNoiseTrajectoryCalc.this.getAlphaDotInitial()
//						*(1-(LandingNoiseTrajectoryCalc.this.getkAlphaDot()*(LandingNoiseTrajectoryCalc.this.getAlpha().get(
//								LandingNoiseTrajectoryCalc.this.getAlpha().size()-1).getEstimatedValue()))
//								);
//			}
...
//
//			double alpha = LandingNoiseTrajectoryCalc.this.getAlphaGround().getEstimatedValue();
//			
...
//						LandingNoiseTrajectoryCalc.this.getAlpha().size()-1).getEstimatedValue()
//				+(alphaDot(time)*(LandingNoiseTrajectoryCalc.this.getTime().get(
//						LandingNoiseTrajectoryCalc.this.getTime().size()-1).getEstimatedValue()
//						- LandingNoiseTrajectoryCalc.this.getTime().get(
//								LandingNoiseTrajectoryCalc.this.getTime().size()-2).getEstimatedValue()));
//			else if(time > tZeroAccelration.doubleValue(SI.SECOND)) {
//				
//				@SuppressWarnings("unused")
//				int j=0;
//				
//				double acceleration = LandingNoiseTrajectoryCalc.this.getAcceleration().get(
//						LandingNoiseTrajectoryCalc.this.getAcceleration().size()-1
