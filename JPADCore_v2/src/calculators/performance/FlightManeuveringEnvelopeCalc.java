...
public class FlightManeuveringEnvelopeCalc {
	...
	public String toString() {
		...
		if(_regulations == RegulationsEnum.FAR_23) {
			...
			.append("\t\t.....................................\n")
			.append("\t\t\tStall speed clean = " + getStallSpeedClean().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tStall speed clean = " + getStallSpeedClean().to(NonSI.KNOT) + "\n")
			.append("\t\t\tStall speed inverted = " + getStallSpeedInverted().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(NonSI.KNOT) + "\n")
			.append("\t\t\tPositive limit load factor maneuvering speed = " + getPositiveLoadFactorManeuveringSpeed() + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tCruising speed = " + getCruisingSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tCruising speed = " + getCruisingSpeed().to(NonSI.KNOT) + "\n")
			.append("\t\t\tPositive limit load factor cruising speed = " + getPositiveLoadFactorCruisingSpeed() + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tDive speed = " + getDiveSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tDive speed = " + getDiveSpeed().to(NonSI.KNOT) + "\n")
			...
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tManeuvering speed inverted = " + getManeuveringSpeedInverted().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tManeuvering speed inverted = " + getManeuveringSpeedInverted().to(NonSI.KNOT) + "\n")
			...
			.append("\t\t.....................................\n")
			.append("\t\t\tStall speed full flap = " + getStallSpeedFullFlap().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tStall speed full flap = " + getStallSpeedFullFlap().to(NonSI.KNOT) + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tManeuvering speed full flap = " + getManeuveringFlapSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tManeuvering speed full flap = " + getManeuveringFlapSpeed().to(NonSI.KNOT) + "\n")
			.append("\t\t\tPositive limit load factor full flap maneuvering speed = " + getPositiveLoadFactorDesignFlapSpeed() + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tDesign speed full flap = " + getDesignFlapSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tDesign speed full flap = " + getDesignFlapSpeed().to(NonSI.KNOT) + "\n")
			.append("\t\t\tPositive limit load factor full flap maneuvering speed = " + getPositiveLoadFactorDesignFlapSpeed() + "\n")
			.append("\t\t.....................................\n")
			...
			if (_aircraftType != AircraftTypeEnum.COMMUTER)
				sb.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(SI.METERS_PER_SECOND) + "\n")
				.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(NonSI.KNOT) + "\n")
				.append("\t\t\tPositive limit load factor maneuvering speed (GUST) = " + getPositiveLoadFactorManeuveringSpeedWithGust() + "\n")
				.append("\t\t\t_____________________________________\n");		

			sb.append("\t\t\tCruising speed = " + getCruisingSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tCruising speed = " + getCruisingSpeed().to(NonSI.KNOT) + "\n")
			...
			if (_aircraftType != AircraftTypeEnum.COMMUTER)
				...
				.append("\t\t\tManeuvering speed = " + getManeuveringSpeedInverted().to(SI.METERS_PER_SECOND) + "\n")
				.append("\t\t\tManeuvering speed = " + getManeuveringSpeedInverted().to(NonSI.KNOT) + "\n")
			...
			.append("\t\t\tStall speed clean = " + getStallSpeedClean().to(NonSI.KNOT) + "\n")
			.append("\t\t\tStall speed inverted = " + getStallSpeedInverted().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tStall speed inverted = " + getStallSpeedInverted().to(NonSI.KNOT) + "\n")
			.append("\t\t\t_____________________________________\n")
			.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(SI.METERS_PER_SECOND) + "\n")
			.append("\t\t\tManeuvering speed = " + getManeuveringSpeed().to(NonSI.KNOT) + "\n")
			.append("\t\t\tPositive limit load factor maneuvering speed = " + getPositiveLoadFactorManeuveringSpeed() + "\n")
