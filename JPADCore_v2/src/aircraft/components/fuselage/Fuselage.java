...
public class Fuselage {
	...
	private Amount<Length> xApexConstructionAxes = Amount.valueOf(0.0, SI.METER); 
	...
	public void setTheBalance(FuselageBalanceManager _theBalance) {
		this.theBalanceManager = _theBalance;
	}
	...
	public void setFusDesDatabaseReader(FusDesDatabaseReader _fusDesDatabaseReader) {
		this.fusDesDatabaseReader = _fusDesDatabaseReader;
	}
	...
	public void setHeightFromGround(Amount<Length> heightFromGround) {
		setTheFuselageCreatorInterface(IFuselage.Builder.from(theFuselageCreatorInterface).setHeightFromGround(heightFromGround).build());
	}
	...
	public void setDeckNumber(int deckNumber) {
		setTheFuselageCreatorInterface(IFuselage.Builder.from(theFuselageCreatorInterface).setDeckNumber(deckNumber).build());
	}
