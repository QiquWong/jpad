...
//			surface = (tipChord + (taperRatio/tipChord))*ar*0.5;
		...
		if(_theLiftingSurfaceInterface.getType().equals(ComponentEnum.WING)) {
			...
			setTheLiftingSurfaceInterface(
					ILiftingSurface.Builder.from(_theLiftingSurfaceInterface)
	...
	public void setEquivalentWingFlag (boolean equivalentWingFlag) {
		setTheLiftingSurfaceInterface(ILiftingSurface.Builder.from(_theLiftingSurfaceInterface).setEquivalentWingFlag(equivalentWingFlag).build());
	}
	...
	public LiftingSurfaceBalanceManager getTheBalanceManager() {
		return _theBalanceManager;
	}
