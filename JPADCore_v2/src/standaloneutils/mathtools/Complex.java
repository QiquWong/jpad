...
* <p>
*
*  <p>  Modified by:  Joseph A. Huwaldt,	April 3, 2014,  Added "equals()" and "hashCode()". </p>
**/
...
public class Complex implements Cloneable, Serializable {
	...
	*  and is a Complex object that has exactly the same
	*  imaginary and real parts as this object.
	**/
    @Override
