...
public class FloatTable implements Cloneable, Serializable {
	...
	*
	*  @param  tableName  The name to be given to this table.
	...
	*                 dimension.
	*  @return The value of the specified breakpoint.
	**/
	...
	*  </p>
	*
	*  @param  independents The list of n-dimensional independent variables to use
	...
	*  </p>
	*
	*  @param  independent The independent variable to use for the table look up.
