...
abstract class AVLBody_Builder {
  ...
  // allows the JVM to optimize away the Optional objects created by and
  // passed to our API.
  private Fuselage fuselageObject = null;
  // Store a nullable object instead of an Optional. Escape analysis then
  // allows the JVM to optimize away the Optional objects created by and
  // passed to our API.
  ...
  /**
   * Sets the value to be returned by {@link AVLBody#getFuselageObject()}.
   *
   * @return this {@code Builder} object
   * @throws NullPointerException if {@code fuselageObject} is null
   */
  public AVLBody.Builder setFuselageObject(Fuselage fuselageObject) {
    this.fuselageObject = Preconditions.checkNotNull(fuselageObject);
    return (AVLBody.Builder) this;
  }
   ...
   * @return this {@code Builder} object
   */
  public AVLBody.Builder setFuselageObject(Optional<? extends Fuselage> fuselageObject) {
    if (fuselageObject.isPresent()) {
      return setFuselageObject(fuselageObject.get());
    } else {
      return clearFuselageObject();
    }
  }
   ...
   * @return this {@code Builder} object
   */
  public AVLBody.Builder setNullableFuselageObject(@Nullable Fuselage fuselageObject) {
    if (fuselageObject != null) {
      return setFuselageObject(fuselageObject);
    } else {
      return clearFuselageObject();
    }
  }
  ...
  /**
   * If the value to be returned by {@link AVLBody#getFuselageObject()} is present,
   * replaces it by applying {@code mapper} to it and using the result.
   *
   * <p>If the result is null, clears the value.
   *
   ...
   * @throws NullPointerException if {@code mapper} is null
   */
  public AVLBody.Builder mapFuselageObject(UnaryOperator<Fuselage> mapper) {
    return setFuselageObject(getFuselageObject().map(mapper));
  }
   ...
   * @return this {@code Builder} object
   */
  public AVLBody.Builder clearFuselageObject() {
    this.fuselageObject = null;
    return (AVLBody.Builder) this;
  }

  /**
   * Returns the value that will be returned by {@link AVLBody#getFuselageObject()}.
   */
  public Optional<Fuselage> getFuselageObject() {
    return Optional.ofNullable(fuselageObject);
  }
  ...
  public AVLBody.Builder mergeFrom(AVLBody value) {
    ...
    value.getFuselageObject().ifPresent(this::setFuselageObject);
  ...
  public AVLBody.Builder mergeFrom(AVLBody.Builder template) {
    ...
    template.getFuselageObject().ifPresent(this::setFuselageObject);
  ...
  public AVLBody.Builder clear() {
    ...
    fuselageObject = _defaults.fuselageObject;
  ...
  private static final class Value implements AVLBody {
    ...
    // allows the JVM to optimize away the Optional objects created by our
    // getter method.
    private final Fuselage fuselageObject;
    // Store a nullable object instead of an Optional. Escape analysis then
    // allows the JVM to optimize away the Optional objects created by our
    // getter method.
    ...
    private Value(AVLBody_Builder builder) {
      ...
      this.fuselageObject = builder.fuselageObject;
    ...
    public boolean equals(Object obj) {
      ...
      return Objects.equals(description, other.description)
          ...
          && Objects.equals(fuselageObject, other.fuselageObject)
    ...
    public String toString() {
      return "AVLBody{"
          + COMMA_JOINER.join(
              ...
              (fuselageObject != null ? "fuselageObject=" + fuselageObject : null),
