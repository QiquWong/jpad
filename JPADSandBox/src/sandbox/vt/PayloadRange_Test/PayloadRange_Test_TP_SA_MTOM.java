...
public class PayloadRange_Test_TP_SA_MTOM{
	...
	//------------------------------------------------------------------------------------------
	//BUILDER:
	public PayloadRange_Test_TP_SA_MTOM(){
	...
	public static void main(String[] args) throws HDF5LibraryException, NullPointerException, CmdLineException{
		...
		//--------------------------------------------------------------------------------------
		// Input data
		Amount<Angle> sweepLEEquivalent = (Amount<Angle>)reader.getXMLAmountWithUnitByPath("//ATR72/SweepLE");
		Amount<Mass> maxTakeOffMass = (Amount<Mass>)reader.getXMLAmountWithUnitByPath("//ATR72/Maximum_take_off_mass"); 
		Amount<Mass> operatingEmptyMass = (Amount<Mass>)reader.getXMLAmountWithUnitByPath("//ATR72/Operating_empty_mass");
		Amount<Mass> maxFuelMass = (Amount<Mass>)reader.getXMLAmountWithUnitByPath("//ATR72/Maximum_fuel_mass");
		Amount<Area> surface = (Amount<Area>)reader.getXMLAmountWithUnitByPath("//ATR72/Planform_surface");
		...
		List<String> nPassMax_property = reader.getXMLPropertiesByPath("//ATR72/Maximum_number_of_passengers");
