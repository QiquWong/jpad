...
public class Landing_Test_TF_Sensibility {

	private static long _startTimeCalculation, _startTimeGraph, _stopTimeCalculation,
	_stopTimeGraph, _stopTimeTotal, _elapsedTimeTotal, _elapsedTimeCalculation, _elapsedTimeGraph;
	...
	//------------------------------------------------------------------------------------------
	//BUILDER:
	public Landing_Test_TF_Sensibility() {
