...
public class TakeOff_Test_TF {
	...
	public static void main(String[] args) throws CmdLineException, InstantiationException, IllegalAccessException {
		...
		System.out.println("-----------------------------------------------------------");
		System.out.println("TakeOff_Test :: B747-100B");
		System.out.println("-----------------------------------------------------------\n");

		TakeOff_Test_TF main = new TakeOff_Test_TF();
...
//		double k2 = 0.365;
		...
		double deltaCD0LandingGear = 0.024; // see chart Nicolai pag.273 pdf
