...
public class TakeOff_Test_TF_Sensibility {
	...
	//------------------------------------------------------------------------------------------
	//BUILDER:
	public TakeOff_Test_TF_Sensibility() {
	...
	public static void main(String[] args) throws CmdLineException, InstantiationException, IllegalAccessException {
		...
		TakeOff_Test_TF_Sensibility main = new TakeOff_Test_TF_Sensibility();
...
//		aircraft.get_powerPlant().get_engineList().get(0).set_t0(Amount.valueOf(163200, SI.NEWTON));
