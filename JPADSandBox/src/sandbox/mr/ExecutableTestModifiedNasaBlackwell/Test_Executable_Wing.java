...
public class Test_Executable_Wing {
	...
	public static void main(String[] args) throws CmdLineException, ParserConfigurationException, InstantiationException, IllegalAccessException {
		...
		System.out.println("--------------");
		System.out.println("Wing aerodynamic Analysis. Nasa Blackwell Modified Method");
		System.out.println("--------------");
		...
		// Set the folders tree
				...
				String filenameWithPathAndExt = MyConfiguration.getDir(FoldersEnum.OUTPUT_DIR)+ "WingAnalysis_Output.xml"; 
