...
public class ArgumentsJPADReport {

	@Option(name = "-mwd", aliases = { "--matlab-working-dir" }, required = true,
			usage = "path to Matlab sources")
	private File _matlabWorkingDirectory;
	...
	public File getMatlabWorkingDirectory() {
		return _matlabWorkingDirectory;
	}
