 ...
 * generate RMI server proxy objects for instances of MReportUtils.MReportUtils.
 */
public interface MReportUtilsRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>closeChapter</code> MATLAB 
     ...
     */
    public Object[] closeChapter(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>closeReport</code> MATLAB 
     ...
     * in communication with the server.
     */
    public Object[] makeChapter(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>makeFigure</code> MATLAB 
     ...
     * in communication with the server.
     */
    public Object[] makeFigure(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>makeParagraph</code> MATLAB 
     * function with 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] makeParagraph(Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>makeReport</code> MATLAB 
     * function with 8 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     * supported Java type (i.e. scalars and multidimensional arrays of any numeric, 
     ...
     * in communication with the server.
     */
    public Object[] makeTable(Object... rhs) throws RemoteException;
