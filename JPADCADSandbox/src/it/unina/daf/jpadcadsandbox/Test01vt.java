...
//		allShapes.addAll(canardShapes);
		...
		// write to a file
		AircraftUtils.getAircraftSolidFile(allShapes, (theAircraft.getId() + "_brep"), FileExtension.BREP);
		AircraftUtils.getAircraftSolidFile(allShapes, (theAircraft.getId() + "_stl"), FileExtension.STL);
