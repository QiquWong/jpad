...
import it.unina.daf.jpadcadsandbox.Test27mds.AttachmentType;
import it.unina.daf.jpadcadsandbox.utils.AircraftCADUtils;
import it.unina.daf.jpadcadsandbox.utils.AircraftCADUtils.FairingPosition;
...
public class Test34mds {
	...
	public static void main(String[] args) {
		...
		if (wing != null) {
			...
			wing.setZApexConstructionAxes(wing.getZApexConstructionAxes().plus(Amount.valueOf(-1.7, SI.METER)));
