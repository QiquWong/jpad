...
//		gp_Trsf engineRotate = new gp_Trsf();
//		
...
//							));
//			
//			engineRotate.SetRotation(
//					new gp_Ax1(OCCUtils.getShapeCG(translatedEngineCompound), yDir), 
//					engine.getTiltingAngle().doubleValue(SI.RADIAN));
//			
//			OCCShape rotatedEngineCompound = (OCCShape) OCCUtils.theFactory.newShape(
//					TopoDS.ToCompound(
//							new BRepBuilderAPI_Transform(translatedEngineCompound.getShape(), engineRotate, 0).Shape()
//							));
//			
//			OCCExplorer finalEngineExp = new OCCExplorer();
//			finalEngineExp.init(rotatedEngineCompound, CADShapeTypes.SOLID);
//			
