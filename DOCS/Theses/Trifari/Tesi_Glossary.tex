...
\newdualentry{AF} % label
  ...
  {Is the combination of three main efficiency: the propulsive efficiency represented by SFC, the propeller efficiency $\eta_{p}$ or the jet efficiency represented by V and, finally, the aerodynamic efficiency $\frac{L}{D}$} % description
