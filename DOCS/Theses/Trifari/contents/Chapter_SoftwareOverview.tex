...
\begin{figure}[!t]
\centering
\includegraphics[keepaspectratio, width=0.85\textwidth]{flowchartBoeing1}
...
\begin{figure}[!b]
\centering
\includegraphics[keepaspectratio, width=0.75\textwidth]{Folder_Tree}
...
\begin{enumerate}
	...
	\item \textbf{Project tree} (on the left), which is key component of the \gls{acr:GUI} that provides access to all the components of the aircraft and the analysis results any time during the execution of the application. The project tree appears once an aircraft is created and can be eventually hidden
