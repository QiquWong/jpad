...
\bigskip
\lstset{language=XML}
\begin{lstlisting}[caption={Example of high-lift devices .xml input file for the B747-100B in take-off configuration}, captionpos=b, tabsize=6]
<input>
	<B747>
		...
		<Slat2>
			...
			<cExt_c unit="">1.1</cExt_c>
			<LEradius_c_ratio unit="">0.0097</LEradius_c_ratio>
			<Slat_inboard unit="">0.4279</Slat_inboard>
			<Slat_outboard unit="">0.6578</Slat_outboard>
		</Slat2>
		<Slat3>
			<Delta_Slat unit="$\deg$">20</Delta_Slat>
			<Cs_C unit="">0.243</Cs_C>
			<cExt_c unit="">1.1</cExt_c>
			<LEradius_c_ratio unit="">0.0097</LEradius_c_ratio>
			<Slat_inboard unit="">0.666</Slat_inboard>
			<Slat_outboard unit="">0.997</Slat_outboard>
		</Slat3>
	</B747>
</input>
\end{lstlisting}
...
\bigskip
\lstset{language=XML}
\begin{lstlisting}[caption={Example of high-lift devices .xml input file for the ATR-72 in take-off configuration}, captionpos=b, tabsize=6]
<input>
	<ATR72>
		<Flap_Number unit="">2</Flap_Number>
		<Flap1>
