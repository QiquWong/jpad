...
%
\begin{equation}
S_{w,f}=\left(\dfrac{b}{2}\right)c_r\left[2-\left(1-\lambda\right)\left(\eta_{\text{in}}+\eta_{\text{out}}\right)\right]\left(\eta_{\text{out}}-\eta_{\text{in}}\right)
\label{eqn:Swf}
\end{equation}
%
\begin{figure}[!b]
...
<input>
	<B747>
		...
		<Flap1>
			...
			<Cf_C unit="">0.25</Cf_C>
			<Delta_Flap1 unit="deg">10</Delta_Flap1>
			<Delta_Flap1 unit="deg">5</Delta_Flap1>
			<Delta_Flap1 unit="deg">5</Delta_Flap1>
			<Flap_inboard>0.104</Flap_inboard>
			<Flap_outboard>0.36</Flap_outboard>
		</Flap1>
		<Flap2>
			<FlapType unit="">TRIPLE_SLOTTED</FlapType>
			<Cf_C unit="">0.25</Cf_C>
			<Delta_Flap2 unit="deg">10</Delta_Flap2>
			<Delta_Flap2 unit="'deg'>5</Delta_Flap2>
			<Delta_Flap2 unit="deg">5</Delta_Flap2>
			<Flap_inboard unit="">0.4</Flap_inboard>
			<Flap_outboard unit="">0.65</Flap_outboard>
		</Flap2>
				<Slat1>
...
deltaCl0_flap = 2.172981203979777
deltaCL0_flap = 0.724319798015853
deltaClmax_flap = 1.3582164451145418
deltaCLmax_flap = 0.46177228256884406
cLalpha_new = 0.09132163744419602
deltaCD = 0.014971631059778487
deltaCMc_4 = -0.1363967641940515
--------------CLEAN----------------
 alpha max = 16.3168247767857 (deg)
 alpha star = 9.6267723716381 (deg)
 CL max = 1.5842572610046424
 CL star = 0.9782965664494722
 -----------HIGH LIFT-------------- 
 alpha max = 15.44805707492933 (deg)
 alpha star = 5.622083376221805 (deg)
 CL max = 2.0460295435734865
 CL star = 1.3440760810985717
 CL alpha = 5.232729825552432 (1/rad)
\end{lstlisting}
%
\begin{figure}[H]
\centering
...
deltaCl0_flap = 2.5290368840811523
deltaCL0_flap = 0.5203305851595639
deltaClmax_flap = 0.9405065455430581
deltaCLmax_flap = 0.21966744994085435
deltaClmax_slat = 1.9183683261845126
deltaCLmax_slat = 0.3143779520534695
cLalpha_new = 0.07373983724243685
deltaCD = 0.008030013686156273
deltaCMc_4 = -0.08156562521437385
--------------CLEAN----------------
 alpha max = 19.1502511160714 (deg)
 alpha star = 10.3196273526020 (deg)
 CL max = 1.4615744853062498
 CL star = 0.8263686942120971
 -----------HIGH LIFT-------------- 
 alpha max = 21.305379816429568 (deg)
 alpha star = 10.036900239612963 (deg)
 CL max = 1.9956198873005737
 CL star = 1.3445056424426238
 CL alpha = 4.225292673991631 (1/rad)
\end{lstlisting}
%
...
\midrule
$\delta_f$ &  \textbf{} & 30°  & $C_{L\text{max}}$ &  \textbf{} & 2.37 \\
$\frac{c_f}{c}$ &  \textbf{} & 0.25 & $\alpha_{\text{max}}$ &  \textbf{} & 23° \\
Trailing edge devices type &  \textbf{} & Triple Slotted & \textbf{ } &  \textbf{} & \textbf{} \\
$\delta_s$ &  \textbf{} & 25° & \textbf{ } &  \textbf{} & \textbf{} \\
\bottomrule
\end{tabular}
}
...
\begin{figure}[H]
\centering
\input{images/CLAlphaHighLift_DELTA_FLAP_EFFECT.tikz}
\caption{Effects of different $\delta_f$ upon the lift curve of the B747-100B with $\frac{c_f}{c}=0.25$, Triple slotted flaps and $\delta_s=\SI{25}{\degree}$}
\end{figure}
%
\begin{figure}[H]
\centering
\input{images/CLAlphaHighLift_CFC_EFFECT.tikz}
\caption{Effects of different $\frac{c_f}{c}$ upon the lift curve of the B747-100B with $\delta_f=\SI{30}{\degree}$, Triple slotted flaps and $\delta_s=\SI{25}{\degree}$}
\end{figure}
%
\begin{figure}[H]
\centering
\input{images/CLAlphaHighLift_FLAPTYPE_EFFECT.tikz}
\caption{Effects of different trailing edge devices upon the lift curve of the B747-100B with $\delta_f=\SI{30}{\degree}$, $\frac{c_f}{c}=0.25$ and $\delta_s=\SI{25}{\degree}$}
\end{figure}
%
\begin{figure}[H]
\centering
\input{images/CLAlphaHighLift_DELTA_SLAT_EFFECT.tikz}
\caption{Effects of different $\delta_s$ upon the lift curve of the B747-100B with $\delta_f=\SI{30}{\degree}$, $\frac{c_f}{c}=0.25$ and Triple slotted flaps}
