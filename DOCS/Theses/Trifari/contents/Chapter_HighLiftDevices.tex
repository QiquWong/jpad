...
\caption{ATR-72 lift curve with and without flaps deflected}
\label{fig:FlapATR}
\end{figure}
...
deltaCMc_4 = -0.12338582743821447
 ...
 CLmax 1.4934954072726092
 CLstar 1.0956477082461238
 CLalpha 5.189644003702159 (1/rad)
 -----------HIGH LIFT-------------- 
 alpha max 14.50713741489647 (deg)
 alpha star 5.55824828132392 (deg)
 Clmax 2.028759439349697
 Clstar 1.5861753654540678
 Clalpha 5.243472818549172 (1/rad)
\end{lstlisting}
%
\begin{figure}[H]
\centering
\input{images/CLAlphaWingHighLift_B747.tikz}
\caption{B747-100B lift curve with and without flaps and slats deflected}
\label{fig:FlapATR}
\end{figure}
...
deltaCD = 0.006456897617521261
 ...
 CLmax 1.4686492856382116
 CLstar 0.8263686942120971
 CLalpha 4.121408852511741 (1/rad)
 -----------HIGH LIFT-------------- 
 alpha max 27.00200178515614 (deg)
 alpha star 14.091414230062869 (deg)
 Clmax 2.4401186431783097
 Clstar 1.7930955427485755
 Clalpha 4.152629290058694 (1/rad)
\end{lstlisting}