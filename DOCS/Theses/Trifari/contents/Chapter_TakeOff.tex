...
\textbf{FAR-25 Landing field length @ ISA, SL, MTOW} & $\SI{1067}{\meter}$ & $\SI{1098}{\meter}$ & $\approx2.82$\%\\
\bottomrule
\end{tabular}
}
...
\end{itemize}
%
%In order to validate the \lstinline[language=Java]!CalcTakeOff! class results, a comparison between its output and the flight manual of the B747-100B has been made showing the following results.
%%
