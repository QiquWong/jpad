...
\bigskip
\noindent
The ground run begins when the aircraft touches the ground and ends when the speed is equal to zero; the first part of the ground run is named \emph{free-roll distance}, which lasts around $\SI{2}{\second}$, and represents the distance covered while the pilot reduces the power to idle, deploys the spoilers, and applies the brakes. The second part of the ground run is almost the same described during the aborted take-off with the difference that now there is no engine failure and the focus is on the decelerated trait.
...
CLmaxTO = 2.0460295435734865
CL0 = 0.8306582213342026
CLground = 0.9676507678190003
CD0 clean = 0.02764101359564796
Delta CD0 flap = 0.014971631059778487
Delta CD0 landing gears = 0.014
CD0 TakeOff = 0.056612644655426446
Induced CD TakeOff = 0.015632706574504295
VsTO = 53.7251510036951 m/s
VRot = 56.4114085538798 m/s
VLO = 60.7094206341754 m/s
---------------------------------------------------
		END OF GROUND ROLL PHASE
	switching function changes sign at t = 25.02838976803771
	x[0] = s = 766.4085307220015 m
	x[1] = V = 56.41140855387982 m/s
	x[2] = gamma = 0.0 deg
	x[3] = altitude = 0.0 m
	COLLECTING DATA AT THE END OF GROUND ROLL PHASE ...
---------------------------DONE!-------------------------------
		END OF ROTATION PHASE
	x[0] = s = 966.4527523037596 m
	x[1] = V = 61.66242785146666 m/s
	x[2] = gamma = 0.0 deg
	x[3] = altitude = 0.0 m
	t = 28.414603694895476 s
	COLLECTING DATA AT THE END OF ROTATION PHASE ...
---------------------------DONE!-------------------------------
		BEGIN BAR HOLDING
	CL = 1.74015080986302
	Alpha Body = 8.459223399652481 deg
	t = 29.775459186670766 s
---------------------------DONE!-------------------------------
		END BAR HOLDING
	switching function changes sign at t = 30.275459186670762
---------------------------DONE!-------------------------------
		LOAD FACTOR = 1 IN CLIMB
	t = 31.523314424554282 s
---------------------------DONE!-------------------------------
		END OF AIRBORNE PHASE
	switching function changes sign at t = 32.40675603917523
	x[0] = s = 1221.2507746200124 m
	x[1] = V = 65.40090174955925 m/s
	x[2] = gamma = 4.003887178321865 deg
	x[3] = altitude = 10.668000002612555 m
	COLLECTING DATA AT THE END OF AIRBORNE PHASE ...
---------------------------DONE!-------------------------------
TAKE-OFF DISTANCE = 1221.25077462001 m
FAR-25 TAKE-OFF FIELD LENGTH = 1404.43839081301 m
BALANCED FIELD LENGTH = 1532.15360168038 m
Decision Speed (V1/VsTO) = 1.09326811806384 
---------------------------END!!-------------------------------
\end{lstlisting}

\bigskip
\begin{lstlisting}[caption={ATR-72 landing test results}, captionpos=b, tabsize=2]
CLmaxLanding = 2.629500611621687
CL0 = 1.2576830646863195
CLground = 1.391714345758023
CD0 clean = 0.02764101359564796
Delta CD0 flap = 0.06839423103599737
Delta CD0 landing gears = 0.015
Delta CD0 spoilers = 0.011
CD0 Landing = 0.12203524463164533
Induced CD Landing = 0.03233680390808114
VsLanding = 45.5187474012974 m/s
V_Approach = 59.174371621687 m/s
V_Flare = 55.9880593035958 m/s
V_TouchDown = 52.3465595114920 m/s
-----------------------------------------------------------
		END OF THE LANDING GROUND ROLL
	switching function changes sign at t = 13.059309188911367
	x[0] = s = 687.8790923064995 m
	x[1] = V = -8.15493506056697E-15 m/s
---------------------------DONE!-------------------------------
------------------------RESULTS----------------------------
AIRBORNE DISTANCE = 162.266573561976 m
FLARE DISTANCE = 111.4871144730608 m
GROUND ROLL DISTANCE = 414.12540427146 m
TOTAL LANDING DISTANCE = 687.879092306499 m
FAR-25 FIELD LENGTH = 1146.46515384417 m
-----------------------------------------------------------
\end{lstlisting}
%
As can be seen the take-off distance required in \gls{acr:AOE} condition is about $\SI{1221}{\meter}$, at the maximum take-off mass of $\SI{22500}{\kilogram}$ and at sea level in standard atmospheric conditions, within a time of about $\SI{32.5}{\second}$; while the \emph{balanced field length} is bigger than the \gls{acr:AOE} take-off distance of about the 20\%. Moreover the \emph{decision speed} $V_1$ is bigger than the stalling speed $V_s$ as required by the \gls{FAR}-25 from table \ref{tab:Take:Off:Speeds:FAR25}. Comparing the \emph{FAR-25 take-off field lenght}, which is the 15\% bigger than the one calculated, with the take-off field length shown on the public brochure of the ATR 72-500, the two number are different of about the 7.4\%, validating, this way, the calculation made.  

\bigskip
\noindent
Regarding the landing test, the results obtained show that, at the maximum landing weight and at sea level in standard atmospheric conditions, the calculated landing distance is around $\SI{688}{\meter}$ with a ground roll distance of about $\SI{414}{\meter}$ covered in about $\SI{13}{\second}$. Deriving the \emph{FAR-25 landing field length}, which is obtained dividing the distance calculated by 0.6, this results to be similar to the one proposed onto the ATR 72-500 brochure proving that the calculation method works; in particular, the difference between the two distances is around the 6.89\%.

\bigskip
\noindent
Finally, with reference to the landing charts at the end of the chapter (from figure \ref{fig:Landing1} to \ref{fig:LandingEnd}), the reader can easily recognize the effect of the reverse thrust upon the landing distance; in particular, in case of \lstinline[language=Java]!phiRev!=0.25, the deceleration is bigger so that the speed decreases faster making the total landing distance shorter (about the 11.5\%). It has also to be noted that during the air run, the speed is assumed to be constant during the approach phase for then decrease, with a linear trend, from the $V_A$ to the $V_{\text{TD}}$ during the flare phase. 
%
\begin{table}[H]
\makebox[\linewidth]{
...
\midrule
\textbf{FAR-25 Take-Off field length @ ISA, SL, MTOW} & $\SI{1300}{\meter}$ & $\SI{1404}{\meter}$ & $\approx7$\%\\ [1.0cm]
\textbf{FAR-25 Landing field length @ ISA, SL, MLW} & $\SI{1067}{\meter}$ & $\SI{1146}{\meter}$ & $\approx7$\%\\
\bottomrule
\end{tabular}
}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=1.06\textwidth]{VerticalForces_vs_GroundDistance_OEI}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=\textwidth]{BalancedTakeOffLength.pdf}
...
%
%----------------------- W/S and T/W sensibility analysis -------------------------
...
\begin{table}[H]
  ...
  \adjustbox{max width=\textwidth}{
    ...
    \textbf{W/S\textsubscript{TO}} & 136 lb/$\si{\square\foot}$ & 164 lb/$\si{\square\foot}$ & \textbf{ } \\
...
\begin{table}[H]
  ...
  \adjustbox{max width=\textwidth}{
    ...
    \toprule
    \multicolumn{7}{c}{\textbf{Take-Off analysis at SL with $C_{L\text{max,TO}}=1.995$}} \\
    \midrule
    \multicolumn{1}{c}{\textbf{W/S}} & \multicolumn{1}{c}{\textbf{T/W}} & \multicolumn{1}{c}{\textbf{TO distance}} & \multicolumn{1}{c}{\textbf{FAR-25 TO FL}} & \multicolumn{1}{c}{\textbf{TOP 25}} & \multicolumn{1}{c}{\textbf{Statistical FL}} & \multicolumn{1}{c}{\textbf{Difference (\%)}} \\
    \midrule
    123 lb/$\si{\square\foot}$ & 0.245 N/lb & 2418.82 m & \textbf{2781.64 m} & 251.28 & \textbf{2872.14 m} & \textbf{3.15\%} \\
    136 lb/$\si{\square\foot}$ & 0.245 N/lb & 2704.07 m & \textbf{3109.68 m} & 279.20 & \textbf{3191.26 m} & \textbf{2.56\%} \\
    150 lb/$\si{\square\foot}$ & 0.245 N/lb & 2986.81m & \textbf{3434.83 m} & 307.12 & \textbf{3510.39 m} & \textbf{2.15\%}\\
    164 lb/$\si{\square\foot}$ & 0.245 N/lb & 3278.05 m & \textbf{3769.76 m} & 335.04 & \textbf{3829.52 m} & \textbf{1.56\%}\\
    \midrule
    123 lb/$\si{\square\foot}$ & 0.272 N/lb & 2153.99 m & \textbf{2477.09 m} & 226.15 & \textbf{2584.92 m} & \textbf{4.17\%}\\
    \textbf{136 lb/$\si{\square\foot}$} & \textbf{0.272 N/lb} & \textbf{2403.19 m} & \textbf{2763.67 m} & \textbf{251.28} & \textbf{2872.14 m} & \textbf{3.78\%}\\
    150 lb/$\si{\square\foot}$ & 0.272 N/lb & 2652.01 m & \textbf{3049.81 m} & 276.41 & \textbf{3159.35 m} & \textbf{3.47\%}\\
    164 lb/$\si{\square\foot}$& 0.272 N/lb & 2906.85 m & \textbf{3342.88 m} & 301.54 & \textbf{3446.57 m} & \textbf{3.01\%}\\
    \midrule
    123 lb/$\si{\square\foot}$ & 0.299 N/lb & 1948.37 m & \textbf{2240.62 m} & 205.59  & \textbf{2349.93 m} & \textbf{4.65\%}\\
    136 lb/$\si{\square\foot}$ & 0.299 N/lb & 2169.48 m & \textbf{2494.91 m} & 228.44 & \textbf{2611.03 m} & \textbf{4.45\%} \\
    150 lb/$\si{\square\foot}$ & 0.299 N/lb & 2390.3 m & \textbf{2748.87 m} & 251.28 & \textbf{2872.14 m} & \textbf{4.29\%} \\
    164 lb/$\si{\square\foot}$ & 0.299 N/lb & 2618.57 m & \textbf{3011.36 m} & 274.12  & \textbf{3133.24 m} & \textbf{3.89\%}\\
    \midrule
    123 lb/$\si{\square\foot}$& 0.326 N/lb & 1784.68 m & \textbf{2052.38 m} & 188.46 & \textbf{2154.10 m} & \textbf{4.72\%} \\
    136 lb/$\si{\square\foot}$ & 0.326 N/lb & 1938.98 m & \textbf{2281.57 m} & 209.40 & \textbf{2393.45 m} & \textbf{4.67\%} \\
    150 lb/$\si{\square\foot}$ & 0.326 N/lb & 2183.03 m & \textbf{2510.48 m} & 230.34 & \textbf{2632.79 m} & \textbf{4.65\%} \\
    164 lb/$\si{\square\foot}$ & 0.326 N/lb & 2387.182473.63 m & \textbf{2745.25 m} & 251.28 & \textbf{2872.14 m} & \textbf{4.42\%} \\
    \midrule
    \midrule
    ...
    \midrule
     \multicolumn{3}{c}{\textbf{2763.67 m}} &  \multicolumn{3}{c}{\textbf{3080 m}} &  \multicolumn{1}{c}{\textbf{10.27\%}}\\
    \bottomrule
    \end{tabular}
    }
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_TW_0245}
\caption{\gls{JPAD} take-off field length compared with the statistical field length - T/W=0.245}
\end{figure}
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_TW_0272}
\caption{\gls{JPAD} take-off field length compared with the statistical field length - T/W=0.272}
\end{figure}
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_TW_0299}
\caption{\gls{JPAD} take-off field length compared with the statistical field length - T/W=0.299}
\end{figure}
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_TW_0313}
...
\begin{table}[htbp]
  \centering
    ...
    \toprule
    \multicolumn{6}{c}{\textbf{Landing analysis at SL with $C_{L\text{max,TO}}=2.37$ ($\delta_f=\SI{30}{\degree}$ and $\delta_s=\SI{25}{\degree}$)}} \\
    \midrule
    \multicolumn{1}{c}{\textbf{W/S}} & \multicolumn{1}{c}{\textbf{LND distance (m)}} & \multicolumn{1}{c}{\textbf{FAR-25 LND FL}} & \multicolumn{1}{c}{\textbf{$V_a$}} & \multicolumn{1}{c}{\textbf{Statistical FL}} & \multicolumn{1}{c}{\textbf{Difference (\%)}} \\
        \midrule
    96 lb/$\si{\square\foot}$ & 1161.35 m & \textbf{1935.58 m} & 73.28 m/s & \textbf{1855.19 m} & \textbf{4.33\%}\\
    \textbf{107 lb/$\si{\square\foot}$} & \textbf{1248.84 m} & \textbf{2080.18 m} & \textbf{77.24 m/s} & \textbf{2061.32 m}& \textbf{0.91\%}\\
    118 lb/$\si{\square\foot}$ & 1334.92 m & \textbf{2224.86 m} & 81.04 m/s & \textbf{2269.22 m} & \textbf{1.95\%}\\
        \midrule
        \midrule
        \multicolumn{2}{c}{\textbf{FAR-25 FL @ baseline W/S}} & \multicolumn{2}{c}{\textbf{Flight manual}} & \multicolumn{2}{c}{\textbf{Difference (\%)}}\\
    \midrule
     \multicolumn{2}{c}{\textbf{2080.18 m}} &  \multicolumn{2}{c}{\textbf{1930 m}} &  \multicolumn{2}{c}{\textbf{7.78\%}}\\
	\bottomrule
    \end{tabular}
    }
...
\noindent
The analysis results show an excellent accordance with the statistical data denoting a maximum difference less than the 5\%. Regarding the comparison with the  flight manual, considering the case of 30° of flaps deflection, the difference is a little bit higher but still under the 10\%.

\bigskip
\noindent
It has to be noted that \gls{JPAD} estimate a lower effect of the wing loading if compared with the statistical trend but this can be caused by the fact that the latter is obtained comparing different aircrafts, with different wing loadings, with their related landing field length; instead, in this case, is always the same aircraft that is compared with the statistical results at different wing loadings. Two different aircrafts, with the same wing loading, can have different weights so that the landing distance is obviously different.
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_30deg}
\caption{\gls{JPAD} landing field length compared with the statistical field length - $\delta_f=\SI{30}{\degree}$}
\end{figure}
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=\textwidth]{JPAD_TakeOff_Sensibility_B747_Va}
...
\end{figure}
%
%----------------------- Field length altitude sensibility analysis -------------------------
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{TakeOff_Trajectory_B747.png}
\caption{Take-off trajectory comparison - B747-100B at SL, 2000 ft ,4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{Altitude_Evolution_B747.png}
\caption{Altitude evolution with time - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{Speed_Evolution_B747.png}
\caption{Speed evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{CL_Evolution_B747.png}
\caption{$C_L$ evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{LoadFactor_Evolution_B747.png}
\caption{Load factor evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{Acceleration_Evolution_B747.png}
\caption{Acceleration evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=\textwidth]{HorizontalForces_Evolution_B747.png}
\caption{Horizontal forces evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%
%
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=\textwidth]{VerticalForces_Evolution_B747.png}
\caption{Vertical forces evolution with the take-off distance - B747-100B at SL, 2000 ft, 4000 ft}
\end{figure}
%