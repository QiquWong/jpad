...
\textbf{FAR-25 Landing field length @ ISA, SL, MLW} & $\SI{1067}{\meter}$ & $\SI{1098}{\meter}$ & $\approx2.82$\%\\
\bottomrule
\end{tabular}
}
...
\begin{table}[H]
  ...
  \adjustbox{max width=\textwidth}{
    ...
    \toprule
    \multicolumn{7}{c}{\textbf{Take-Off analysis at SL with $C_{L\text{max,TO}}=1.91$}} \\
    \midrule
    ...
    \midrule
    123 lb/$\si{\square\foot}$ & 0.245 N/lb & 2505.38 m & \textbf{2881.19 m} & 261.63 & \textbf{2990.42 m} & \textbf{3.65\%} \\
    136 lb/$\si{\square\foot}$ & 0.245 N/lb & 2791.10 m & \textbf{3209.76 m} & 290.70 & \textbf{3322.69 m} & \textbf{3.40\%} \\
    150 lb/$\si{\square\foot}$ & 0.245 N/lb & 3076.82 m & \textbf{3538.35 m} & 319.77 & \textbf{3654.96 m} & \textbf{3.19\%}\\
    164 lb/$\si{\square\foot}$ & 0.245 N/lb & 3371.01 m & \textbf{3876.66 m} & 348.84 & \textbf{3987.23 m} & \textbf{2.77\%}\\
    \midrule
    123 lb/$\si{\square\foot}$ & 0.272 N/lb & 2242.39 m & \textbf{2578.75 m} & 235.47 & \textbf{2691.38 m} & \textbf{4.18\%}\\
    \textbf{136 lb/$\si{\square\foot}$} & \textbf{0.272 N/lb} & \textbf{2493.63 m} & \textbf{2867.67 m} & \textbf{261.63} & \textbf{2990.42 m} & \textbf{4.10\%}\\
    150 lb/$\si{\square\foot}$ & 0.272 N/lb & 2744.71 m & \textbf{3156.41 m} & 287.79 & \textbf{3289.46 m} & \textbf{4.04\%}\\
    164 lb/$\si{\square\foot}$& 0.272 N/lb & 3001.81 m & \textbf{3452.08 m} & 313.96 & \textbf{3588.51 m} & \textbf{3.80\%}\\
    \midrule
    123 lb/$\si{\square\foot}$ & 0.299 N/lb & 2029.94 m & \textbf{2334.43 m} & 214.06  & \textbf{2446.71 m} & \textbf{4.59\%}\\
    136 lb/$\si{\square\foot}$ & 0.299 N/lb & 2255.07 m & \textbf{2593.33 m} & 237.84 & \textbf{2718.57 m} & \textbf{4.61\%} \\
    150 lb/$\si{\square\foot}$ & 0.299 N/lb & 2479.6 m & \textbf{2851.56 m} & 261.63 & \textbf{2990.42 m} & \textbf{4.64\%} \\
...
\begin{table}[htbp]
  \centering
    ...
    \toprule
    \multicolumn{6}{c}{\textbf{Landing analysis at SL with $C_{L\text{max,TO}}=2.55$ ($\delta_f=\SI{30}{\degree}$ and $\delta_s=\SI{15}{\degree}$)}} \\
    \midrule
    \multicolumn{1}{c}{\textbf{W/S}} & \multicolumn{1}{c}{\textbf{LND distance (m)}} & \multicolumn{1}{c}{\textbf{FAR-25 LND FL}} & \multicolumn{1}{c}{\textbf{$V_a$}} & \multicolumn{1}{c}{\textbf{Statistical FL}} & \multicolumn{1}{c}{\textbf{Difference (\%)}} \\
        \midrule
    96 lb/$\si{\square\foot}$ & 1075.05 m & \textbf{1791.74 m} & 70.69 m/s & \textbf{1726.63 m} & \textbf{3.77\%}\\
    \textbf{107 lb/$\si{\square\foot}$} & \textbf{1152.87 m} & \textbf{1921.45 m} & \textbf{74.52 m/s} & \textbf{1918.47 m}& \textbf{0.16\%}\\
    118 lb/$\si{\square\foot}$ & 1230.77 m & \textbf{2051.29 m} & 78.18 m/s & \textbf{2111.97 m} & \textbf{2.87\%}\\
        \midrule
        \midrule
        \multicolumn{2}{c}{\textbf{FAR-25 FL @ baseline W/S}} & \multicolumn{2}{c}{\textbf{Flight manual}} & \multicolumn{2}{c}{\textbf{Difference (\%)}}\\
    \midrule
     \multicolumn{2}{c}{\textbf{1921.45 m}} &  \multicolumn{2}{c}{\textbf{1930 m}} &  \multicolumn{2}{c}{\textbf{0.44\%}}\\
	\bottomrule
    \end{tabular}
    }
...
\begin{table}[htbp]
  \centering
    ...
    \begin{tabular}{r|r|r|r|r|r}
    \toprule
    \multicolumn{6}{c}{\textbf{Landing analysis at SL with $C_{L\text{max,TO}}=2.43$ ($\delta_f=\SI{25}{\degree}$ and $\delta_s=\SI{15}{\degree}$)}} \\
    \midrule
    \multicolumn{1}{c}{\textbf{W/S}} & \multicolumn{1}{c}{\textbf{LND distance (m)}} & \multicolumn{1}{c}{\textbf{FAR-25 LND FL}} & \multicolumn{1}{c}{\textbf{$V_a$}} & \multicolumn{1}{c}{\textbf{Statistical FL}} & \multicolumn{1}{c}{\textbf{Difference (\%)}} \\
        \midrule
    96 lb/$\si{\square\foot}$ & 1100.18 m & \textbf{1833.63 m} & 72.36 m/s & \textbf{1809.06 m} & \textbf{1.36\%}\\
    \textbf{107 lb/$\si{\square\foot}$} & \textbf{1180.64 m} & \textbf{1967.73 m} & \textbf{76.27 m/s} & \textbf{2010.06 m}& \textbf{2.11\%}\\
    118 lb/$\si{\square\foot}$ & 1261.20 m & \textbf{2102.00 m} & 80.03 m/s & \textbf{2212.79 m} & \textbf{5.01\%}\\
        \midrule
        \midrule
        \multicolumn{2}{c}{\textbf{FAR-25 FL @ baseline W/S}} & \multicolumn{2}{c}{\textbf{Flight manual}} & \multicolumn{2}{c}{\textbf{Difference (\%)}}\\
    \midrule
     \multicolumn{2}{c}{\textbf{1967.73 m}} &  \multicolumn{2}{c}{\textbf{2080 m}} &  \multicolumn{2}{c}{\textbf{5.40\%}}\\
	\bottomrule
    \end{tabular}
    }
  \caption{Landing sensibility analysis results with $\delta_{\text{flap}}=\SI{25}{\degree}$}
  \label{tab:LandExcel2p43}
\end{table}

\noindent
The analysis results show an excellent accordance with the statistical data denoting a maximum difference of about the 5\%. Regarding the comparison with the  flight manual, the case of 30° of flaps deflection, which is the most realistic situation since is related to a $C_{L\text{max,LND}}=2.55$, gives a result even better by showing a difference almost nothing with the \gls{JPAD} output.
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=0.9\textwidth]{JPAD_TakeOff_Sensibility_B747_25deg}
...
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, width=\textwidth]{JPAD_TakeOff_Sensibility_B747_WS}
