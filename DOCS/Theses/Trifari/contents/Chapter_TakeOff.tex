...
%\begin{figure}[H]
%\centering
%\input{images/LoadFactor_vs_GroundDistance_AOE.tikz}
%\caption{Load factor in AOE condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/LoadFactor_vs_GroundDistance_OEI.tikz}
%\caption{Load factor in OEI condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/LoadFactor_vs_GroundDistance_ABORTED.tikz}
%\caption{Load factor in aborted take-off condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/VerticalForces_vs_GroundDistance_AOE.tikz}
%\caption{Vertical forces in AOE condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/VerticalForces_vs_GroundDistance_OEI.tikz}
%\caption{Vertical forces in OEI condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/VerticalForces_vs_GroundDistance_ABORTED.tikz}
%\caption{Vertical forces in aborted take-off condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/HorizontalForces_vs_GroundDistance_AOE.tikz}
%\caption{Horizontal forces in AOE condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/HorizontalForces_vs_GroundDistance_OEI.tikz}
%\caption{Horizontal forces in OEI condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/HorizontalForces_vs_GroundDistance_ABORTED.tikz}
...
%\begin{figure}[H]
%\centering
%\input{images/Speed_vs_GroundDistance_AOE.tikz}
%\caption{Speed v.s. ground distance in AOE condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/Speed_vs_GroundDistance_OEI.tikz}
%\caption{Speed v.s. ground distance in OEI condition - ATR-72}
%\end{figure}
%%
%\begin{figure}[H]
%\centering
%\input{images/Speed_vs_GroundDistance_ABORTED.tikz}
