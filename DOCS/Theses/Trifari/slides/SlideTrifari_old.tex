...
\hline
\textbf{ATR-72} & \multicolumn{1}{c}{$\SI{1300}{\meter}$} & \multicolumn{1}{c}{$\SI{1350}{\meter}$} & \multicolumn{1}{c}{3.7\%}\\ [.2cm]
\textbf{B747-100B} & \multicolumn{1}{c}{$\SI{3080}{\meter}$} & \multicolumn{1}{c}{$\SI{2868}{\meter}$} & \multicolumn{1}{c}{6.89\%}\\
\hline
\end{tabular}
}
}
...
\vspace*{-0.35cm}
\hspace*{-1.1cm}
\includegraphics[keepaspectratio, width=0.75\textwidth]{images/VerticalForces_Evolution_B747.png}
\end{figure}
}
}
%
...
\vspace*{-0.35cm}
\hspace*{-1.1cm}
\includegraphics[keepaspectratio, width=0.75\textwidth]{images/LoadFactor_vs_GroundDistance_LANDING_B747.pdf}
\end{figure}
}
}
%
