...
\lstdefinestyle{MyxmlStyle} {language=XML}
...
\lfoot{}
\cfoot{}
\rfoot{\scriptsize Carmine Vaselli -- Bachelor Thesis in Aerospace Engineering}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}

\fancypagestyle{appendici}{
\pagestyle{fancy}
\lhead{{\bfseries Appendix \ \thechapter} \; \leftmark}
\chead{}
\rhead{\thepage}
\lfoot{}
\cfoot{}
...
\usepackage[baseurl= http://, colorlinks=true, linkcolor=black, citecolor=black]{hyperref}