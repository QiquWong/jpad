...
public class DatabaseReader {
	...
	private static final MyInterpolatingFunction K_Rudder_vs_ChordRudderOverMAC_VT = aeroDatabase.interpolate2DFromDatasetFunction("(C_n_delta_r)_K_R_vs_eta_(lambda_v)");
	...
	private static final MyInterpolatingFunction kN_Lb_quadro_Over_Side_Surface_first_passage = aeroDatabase.interpolate2DFromDatasetFunction("(C_n_beta_b)_K_N_times_1e-3_vs_x_cg_over_l_b_(squared_l_b_over_S_b_s)_(square_root_(h1_over_h2))_(h_b_over_w_b)","data_0","var_0_0","var_0_1");
	private static final MyInterpolatingFunction kN_Root_Square_z1_Over_z2_second_passage = aeroDatabase.interpolate2DFromDatasetFunction("(C_n_beta_b)_K_N_times_1e-3_vs_x_cg_over_l_b_(squared_l_b_over_S_b_s)_(square_root_(h1_over_h2))_(h_b_over_w_b)","data_1","var_1_0","var_1_1");
	private static final MyInterpolatingFunction kN_zMax_Over_wMax_third_passage = aeroDatabase.interpolate2DFromDatasetFunction("(C_n_beta_b)_K_N_times_1e-3_vs_x_cg_over_l_b_(squared_l_b_over_S_b_s)_(square_root_(h1_over_h2))_(h_b_over_w_b)","data_2","var_2_0","var_2_1");
