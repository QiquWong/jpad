...
public class SandBox {
	...
	// fare gli if per ogni sheet relativo ad un foglio mettiamo il relativo valore del coefficiente e/o grandezza
...
//	    double cl = AeroLibrary.calculateLiftCoefficient(mass, density, mach, soundSpeed, wingSurface);
	    ...
	    double sh = AeroLibrary.calcWingSurface(spanHT, chordHTRoot, taperRatioHT);
	    ...
	    double sVT= AeroLibrary.calcWingSurface(spanVT, chordVTRoot, taperRatioVT);
