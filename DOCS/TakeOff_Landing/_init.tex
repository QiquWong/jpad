...
\def\myAuthorsList{Gennaro~Esposito}
\def\myAuthorListAbbreviated{V.~Trifari}

\def\myDocName{JPAD, a Java Program toolchain for Aircraft Designers}
\def\myDocSubTitle{Development manual}

\def\myFooterLeft{\myAuthorsList\  -- \myDocName}
\def\myFooterRight{\myDocSubTitle}

\def\myDocVersion{ver.~2016.a}% <================== %?[ADJUST-HERE] EDIT THIS STRING AS NEEDED
