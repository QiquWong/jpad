...
c1=8.33;  %root chord (1st station--> y=0)
c2=5;  %chord at second station (--> y=bg)
c3=2.22; %tip chord (3rd station --> Y=b/2
b=35.8;  %wing span
bg=7.22;  %second station
CD0=0.023;  %parasitic drag coefficient    
t=0.74;  %thickness
e=0.80;  %Oswald factor 

Lambda_Le=24.8;  %sweep-angle at leading edge (1st part of the wing)
Lambda_Le=Lambda_Le*pi/180; 
Lambda_Le2=24.8;  %sweep-angle at leading edge (2nd part of the wing)
%%
...
Cl_alpha=0.11;  %curve slope
Cl0=0.25;  %Cl at alpha zero lift
Cl_max=1.8;  %max value of Cl
alpha_star=11;  %angle of attack at the end of linearity
alpha0=-2.3;  %angle of attack at zero lift
...
type_flap=2;                                               
deltaf1=15;  %first deflection
deltaf1=deltaf1*pi/180;
deltaf2=5;  %second deflection
deltaf2=deltaf2*pi/180;
deltaf3=0;  %third deflection
deltaf3=deltaf3*pi/180;
cf=0.833;  %mean flap chord
deltaf=deltaf1+deltaf2+deltaf3;  %flap deflection
deltaf_ref=50;  %deflection reference
deltaf_ref=deltaf_ref*pi/180;
ni=0.14;  %flap inboard
no=0.31;  %flap outboard
...
cf2=0.833;                                                   
deltaf_2=deltaf1_2+deltaf2_2+deltaf3_2;                      
deltaf_ref_2=50;
...
Delta_s=Delta_s*pi/180;
cs=0.555;  %slat chord
c_ext_suC=1.1;  %extended chord to airfoil chord ratio
Le_radius=0.0097;  %Leading edge radius
ni_s=0.403;  %slat inboard
no_s=0.589;  %slat outboard

%Input data for slat 2
Delta_s_2=20;  %slat deflection
Delta_s_2=Delta_s_2*pi/180;
cs2=0.555;  %slat chord
c_ext_suC_2=1.1;  %extended chord to airfoil chord ratio
Le_radius_2=0.0097;  %Leading edge radius
nis2=0.589; %slat inboard
nos2=0.77;  %slat outboard

%Input data for slat 3
Delta_s_3=20;  %slat deflection
Delta_s_3=Delta_s_3*pi/180;
cs3=0.555;  %slat chord
c_ext_suC_3=1.1;  %extended chord to airfoil chord ratio
Le_radius_3=0.0097;  %Leading edge radius
nis3=0.77;  %slat inboard
nos3=0.96;  %slat outboard
%Input data for slat 4
Delta_s_4=0;  %slat deflection
Delta_s_4=Delta_s_4*pi/180;
cs4=0;  %slat chord
...
TsuC=t/c;                                                   
CfsuC=cf/c;
lambda_cquarti=tan(Lambda_Le)-((1-lambda)/(AR*(1+lambda)));
...
Delta_Clmax_slat=dCl_su_dDelta_max*eta_max_s*etadelta_s*Delta_s*180/pi*c_ext_suC;
...
Delta_Clmax_slat_2=dCl_su_dDelta_max_2*eta_max_s_2*etadelta_s_2*Delta_s_2*180/pi*c_ext_suC_2;
...
Delta_Clmax_slat_3=dCl_su_dDelta_max_3*eta_max_s_3*etadelta_s_3*Delta_s_3*180/pi*c_ext_suC_3;
...
alpha_max_2=graficove(CL_alpha1+CL_alpha2-CL_alpha,CL_max1+CL_max2-CL_max, CL01+CL02-CL0,Alpha_star,Alpha0,Delta_alpha_max_2,alpha_max_1);
alpha_max_3=graficog_slat(CL_alpha1+CL_alpha2-CL_alpha,CL_max1_s+CL_max1+CL_max2-2*CL_max,CL01+CL02-CL0, Alpha_star,Alpha0,Delta_alpha_max_s1,alpha_max_2);
alpha_max_4=graficom_slat(CL_alpha1+CL_alpha2-CL_alpha,CL_max1_s+CL_max2_s+CL_max1+CL_max2-3*CL_max,CL01+CL02-CL0, Alpha_star,Alpha0,Delta_alpha_max_s2,alpha_max_3);
graficoc_slat(CL_alpha1+CL_alpha2-CL_alpha,CL_max1_s+CL_max2_s+CL_max3_s+CL_max1+CL_max2-4*CL_max,CL01+CL02-CL0, Alpha_star,Alpha0,Delta_alpha_max_s3,alpha_max_4);
legend('cruise','flap 1 ','flap 2','slat 1','slat 2','slat 3');
title('CL-\alpha graph for the flapped and slatted wing');
