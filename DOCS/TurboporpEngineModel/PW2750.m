...
sfc_h0_TakeOff = csaps( ...
    engineDataATR72_TAKE_OFF(1:13,2), ...
    engineDataATR72_TAKE_OFF(1:13,3)./engineDataATR72_TAKE_OFF(1:13,4), ...
    smoothingParameter ...
    );
...
sfc_h5000_TakeOff = csaps( ...
    engineDataATR72_TAKE_OFF(14:26,2), ...
    engineDataATR72_TAKE_OFF(14:26,3)./engineDataATR72_TAKE_OFF(14:26,4), ...
    smoothingParameter ...
    );
...
sfc_h10000_TakeOff = csaps( ...
    engineDataATR72_TAKE_OFF(27:39,2), ...
    engineDataATR72_TAKE_OFF(27:39,3)./engineDataATR72_TAKE_OFF(27:39,4), ...
    smoothingParameter ...
    );
...
sfc_h15000_TakeOff = csaps( ...
    engineDataATR72_TAKE_OFF(40:52,2), ...
    engineDataATR72_TAKE_OFF(40:52,3)./engineDataATR72_TAKE_OFF(40:52,4), ...
    smoothingParameter ...
    );
...
sfc_h0_Continous = csaps( ...
    engineDataATR72_CONTINOUS(1:13,2), ...
    engineDataATR72_CONTINOUS(1:13,3)./engineDataATR72_CONTINOUS(1:13,4), ...
    smoothingParameter ...
    );
...
sfc_h5000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(14:26,2), ...
    engineDataATR72_CONTINOUS(14:26,3)./engineDataATR72_CONTINOUS(14:26,4), ...
    smoothingParameter ...
    );
...
sfc_h10000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(27:39,2), ...
    engineDataATR72_CONTINOUS(27:39,3)./engineDataATR72_CONTINOUS(27:39,4), ...
    smoothingParameter ...
    );
...
sfc_h15000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(40:52,2), ...
    engineDataATR72_CONTINOUS(40:52,3)./engineDataATR72_CONTINOUS(40:52,4), ...
    smoothingParameter ...
    );
...
sfc_h20000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(53:65,2), ...
    engineDataATR72_CONTINOUS(53:65,3)./engineDataATR72_CONTINOUS(53:65,4), ...
    smoothingParameter ...
    );
...
sfc_h25000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(66:78,2), ...
    engineDataATR72_CONTINOUS(66:78,3)./engineDataATR72_CONTINOUS(66:78,4), ...
    smoothingParameter ...
    );
...
sfc_h30000_Continous = csaps( ...
    engineDataATR72_CONTINOUS(79:91,2), ...
    engineDataATR72_CONTINOUS(79:91,3)./engineDataATR72_CONTINOUS(79:91,4), ...
    smoothingParameter ...
    );
...
sfc_h0_Climb = csaps( ...
    engineDataATR72_CLIMB(1:13,2), ...
    engineDataATR72_CLIMB(1:13,3)./engineDataATR72_CLIMB(1:13,4), ...
    smoothingParameter ...
    );
...
sfc_h5000_Climb = csaps( ...
    engineDataATR72_CLIMB(14:26,2), ...
    engineDataATR72_CLIMB(14:26,3)./engineDataATR72_CLIMB(14:26,4), ...
    smoothingParameter ...
    );
...
sfc_h10000_Climb = csaps( ...
    engineDataATR72_CLIMB(27:39,2), ...
    engineDataATR72_CLIMB(27:39,3)./engineDataATR72_CLIMB(27:39,4), ...
    smoothingParameter ...
    );
...
sfc_h15000_Climb = csaps( ...
    engineDataATR72_CLIMB(40:52,2), ...
    engineDataATR72_CLIMB(40:52,3)./engineDataATR72_CLIMB(40:52,4), ...
    smoothingParameter ...
    );
...
sfc_h20000_Climb = csaps( ...
    engineDataATR72_CLIMB(53:65,2), ...
    engineDataATR72_CLIMB(53:65,3)./engineDataATR72_CLIMB(53:65,4), ...
    smoothingParameter ...
    );
...
sfc_h25000_Climb = csaps( ...
    engineDataATR72_CLIMB(66:78,2), ...
    engineDataATR72_CLIMB(66:78,3)./engineDataATR72_CLIMB(66:78,4), ...
    smoothingParameter ...
    );
...
sfc_h30000_Climb = csaps( ...
    engineDataATR72_CLIMB(79:91,2), ...
    engineDataATR72_CLIMB(79:91,3)./engineDataATR72_CLIMB(79:91,4), ...
    smoothingParameter ...
    );
...
sfc_h0_Idle = csaps( ...
    engineDataATR72_IDLE(1:13,2), ...
    engineDataATR72_IDLE(1:13,3)./engineDataATR72_IDLE(1:13,4), ...
    smoothingParameter ...
    );
...
sfc_h5000_Idle = csaps( ...
    engineDataATR72_IDLE(14:26,2), ...
    engineDataATR72_IDLE(14:26,3)./engineDataATR72_IDLE(14:26,4), ...
    smoothingParameter ...
    );
...
sfc_h10000_Idle = csaps( ...
    engineDataATR72_IDLE(27:39,2), ...
    engineDataATR72_IDLE(27:39,3)./engineDataATR72_IDLE(27:39,4), ...
    smoothingParameter ...
    );
...
sfc_h15000_Idle = csaps( ...
    engineDataATR72_IDLE(40:52,2), ...
    engineDataATR72_IDLE(40:52,3)./engineDataATR72_IDLE(40:52,4), ...
    smoothingParameter ...
    );
...
sfc_h20000_Idle = csaps( ...
    engineDataATR72_IDLE(53:65,2), ...
    engineDataATR72_IDLE(53:65,3)./engineDataATR72_IDLE(53:65,4), ...
    smoothingParameter ...
    );
...
sfc_h25000_Idle = csaps( ...
    engineDataATR72_IDLE(66:78,2), ...
    engineDataATR72_IDLE(66:78,3)./engineDataATR72_IDLE(66:78,4), ...
    smoothingParameter ...
    );
...
sfc_h30000_Idle = csaps( ...
    engineDataATR72_IDLE(79:91,2), ...
    engineDataATR72_IDLE(79:91,3)./engineDataATR72_IDLE(79:91,4), ...
    smoothingParameter ...
    );
...
sfc_h0_Cruise = csaps( ...
    engineDataATR72_CRUISE(1:13,2), ...
    engineDataATR72_CRUISE(1:13,3)./engineDataATR72_CRUISE(1:13,4), ...
    smoothingParameter ...
    );
...
sfc_h5000_Cruise = csaps( ...
    engineDataATR72_CRUISE(14:26,2), ...
    engineDataATR72_CRUISE(14:26,3)./engineDataATR72_CRUISE(14:26,4), ...
    smoothingParameter ...
    );
...
sfc_h10000_Cruise = csaps( ...
    engineDataATR72_CRUISE(27:39,2), ...
    engineDataATR72_CRUISE(27:39,3)./engineDataATR72_CRUISE(27:39,4), ...
    smoothingParameter ...
    );
...
sfc_h15000_Cruise = csaps( ...
    engineDataATR72_CRUISE(40:52,2), ...
    engineDataATR72_CRUISE(40:52,3)./engineDataATR72_CRUISE(40:52,4), ...
    smoothingParameter ...
    );
...
sfc_h20000_Cruise = csaps( ...
    engineDataATR72_CRUISE(53:65,2), ...
    engineDataATR72_CRUISE(53:65,3)./engineDataATR72_CRUISE(53:65,4), ...
    smoothingParameter ...
    );
...
sfc_h25000_Cruise = csaps( ...
    engineDataATR72_CRUISE(66:78,2), ...
    engineDataATR72_CRUISE(66:78,3)./engineDataATR72_CRUISE(66:78,4), ...
    smoothingParameter ...
    );
...
sfc_h30000_Cruise = csaps( ...
    engineDataATR72_CRUISE(79:91,2), ...
    engineDataATR72_CRUISE(79:91,3)./engineDataATR72_CRUISE(79:91,4), ...
    smoothingParameter ...
    );
