 ...
 * @webref math
 */
public class JPADPVector implements Serializable {
  /**
   ...
   */
  public JPADPVector(float x, float y, float z) {
    this.x = x;
    this.y = y;
    this.z = z;
  }
   ...
   */
  public JPADPVector(float x, float y) {
    this.x = x;
    this.y = y;
  }
   ...
   */
  public JPADPVector set(float x, float y, float z) {
    this.x = x;
    this.y = y;
    this.z = z;
    return this;
   ...
   * @param y the y component of the vector
   */
  public JPADPVector set(float x, float y) {
    this.x = x;
    this.y = y;
    this.z = 0;
    return this;
   ...
   */
  public JPADPVector set(JPADPVector v) {
    x = v.x;
    y = v.y;
    z = v.z;
    return this;
   ...
   */
  public JPADPVector set(float[] source) {
    if (source.length >= 2) {
      x = source[0];
      y = source[1];
    }
...
//  }
   ...
   */
  static public JPADPVector fromAngle(float angle) {
   ...
   * @return the PVector
   */
  static public JPADPVector fromAngle(float angle, JPADPVector target) {
    if (target == null) {
      target = new JPADPVector((float)Math.cos(angle),(float)Math.sin(angle),0);
    } else {
   ...
   */
  public JPADPVector copy() {
    return new JPADPVector(x, y, z);
  }


  @Deprecated
  public JPADPVector get() {
    return copy();
  }
   ...
   */
  public JPADPVector add(JPADPVector v) {
    x += v.x;
    y += v.y;
    z += v.z;
    return this;
   ...
   */
  public JPADPVector add(float x, float y) {
    this.x += x;
    this.y += y;
    return this;
  }
   ...
   */
  public JPADPVector add(float x, float y, float z) {
    this.x += x;
    this.y += y;
    this.z += z;
    return this;
   ...
   */
  static public JPADPVector add(JPADPVector v1, JPADPVector v2) {
   ...
   * @param target the target vector (if null, a new vector will be created)
   */
  static public JPADPVector add(JPADPVector v1, JPADPVector v2, JPADPVector target) {
    if (target == null) {
      target = new JPADPVector(v1.x + v2.x,v1.y + v2.y, v1.z + v2.z);
    } else {
   ...
   */
  public JPADPVector sub(JPADPVector v) {
    x -= v.x;
    y -= v.y;
    z -= v.z;
    return this;
   ...
   * @param y the y component of the vector
   */
  public JPADPVector sub(float x, float y) {
    this.x -= x;
    this.y -= y;
    return this;
  }
   ...
   * @param z the z component of the vector
   */
  public JPADPVector sub(float x, float y, float z) {
    this.x -= x;
    this.y -= y;
    this.z -= z;
    return this;
   ...
   */
  static public JPADPVector sub(JPADPVector v1, JPADPVector v2) {
   ...
   */
  static public JPADPVector sub(JPADPVector v1, JPADPVector v2, JPADPVector target) {
    if (target == null) {
      target = new JPADPVector(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
    } else {
      target.set(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
   ...
   */
  public JPADPVector mult(float n) {
    x *= n;
    y *= n;
    z *= n;
    return this;
   ...
   */
  static public JPADPVector mult(JPADPVector v, float n) {
   ...
   * @param target PVector in which to store the result
   */
  static public JPADPVector mult(JPADPVector v, float n, JPADPVector target) {
    if (target == null) {
      target = new JPADPVector(v.x*n, v.y*n, v.z*n);
    } else {
   ...
   */
  public JPADPVector div(float n) {
    x /= n;
    y /= n;
    z /= n;
    return this;
   ...
   */
  static public JPADPVector div(JPADPVector v, float n) {
    return div(v, n, null);
  }
   ...
   * @param target PVector in which to store the result
   */
  static public JPADPVector div(JPADPVector v, float n, JPADPVector target) {
    if (target == null) {
      target = new JPADPVector(v.x/n, v.y/n, v.z/n);
    } else {
      target.set(v.x/n, v.y/n, v.z/n);
   ...
   */
  public float dist(JPADPVector v) {
    float dx = x - v.x;
    float dy = y - v.y;
    float dz = z - v.z;
   ...
   */
  static public float dist(JPADPVector v1, JPADPVector v2) {
    float dx = v1.x - v2.x;
    float dy = v1.y - v2.y;
    float dz = v1.z - v2.z;
    return (float) Math.sqrt(dx*dx + dy*dy + dz*dz);
   ...
   */
  public float dot(JPADPVector v) {
   ...
   * @param v2 any variable of type PVector
   */
  static public float dot(JPADPVector v1, JPADPVector v2) {
   ...
   */
  public JPADPVector cross(JPADPVector v) {
    return cross(v, null);
  }
   ...
   */
  public JPADPVector cross(JPADPVector v, JPADPVector target) {
    float crossX = y * v.z - v.y * z;
    float crossY = z * v.x - v.z * x;
    float crossZ = x * v.y - v.x * y;

    if (target == null) {
      target = new JPADPVector(crossX, crossY, crossZ);
    } else {
   ...
   * @param target PVector to store the result
   */
  static public JPADPVector cross(JPADPVector v1, JPADPVector v2, JPADPVector target) {
   ...
   */
  public JPADPVector normalize(JPADPVector target) {
    if (target == null) {
      target = new JPADPVector();
    }
    float m = mag();
    if (m > 0) {
   ...
   */
  public JPADPVector limit(float max) {
    if (magSq() > max*max) {
      normalize();
      mult(max);
    }
   ...
   */
  public JPADPVector setMag(float len) {
    normalize();
    mult(len);
    return this;
  }
   ...
   * @return a new vector (if target was null), or target
   */
  public JPADPVector setMag(JPADPVector target, float len) {
   ...
   */
  public JPADPVector rotate(float theta) {
    float temp = x;
...
//    y = temp*PApplet.sin(theta) + y*PApplet.cos(theta);
   ...
   */
  public JPADPVector lerp(JPADPVector v, float amt) {
//    x = PApplet.lerp(x, v.x, amt);
//    y = PApplet.lerp(y, v.y, amt);
//    z = PApplet.lerp(z, v.z, amt);
	// https://github.com/processing/processing/blob/master/core/src/processing/core/PApplet.java
    // start + (stop-start) * amt; // from PApplet.java
    this.x = this.x + (v.x - this.x) * amt;
    this.y = this.x + (v.y - this.y) * amt;
    this.z = this.x + (v.z - this.z) * amt;
    return this;
  }
   ...
   */
  public static JPADPVector lerp(JPADPVector v1, JPADPVector v2, float amt) {
    JPADPVector v = v1.copy();
    v.lerp(v2, amt);
    return v;
  }
   ...
   */
  public JPADPVector lerp(float x, float y, float z, float amt) {
...
//    this.z = PApplet.lerp(this.z, z, amt);
    ...
    this.y = this.x + (y - this.y) * amt;
    this.z = this.x + (z - this.z) * amt;
    return this;
  }
   ...
   */
  static public float angleBetween(JPADPVector v1, JPADPVector v2) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof JPADPVector)) {
      return false;
    }
    final JPADPVector p = (JPADPVector) obj;
