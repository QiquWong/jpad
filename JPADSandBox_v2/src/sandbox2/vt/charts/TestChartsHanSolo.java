...
import eu.hansolo.fx.charts.DonutChart;
import eu.hansolo.fx.charts.XYChart;
import eu.hansolo.fx.charts.XYZChart;
...
public class TestChartsHanSolo extends Application {
    ...
    @Override public void init() {
        ...
        xyChartModel  = new XYChartModel<XYDataObject>(xyData);
        scatterChart  = new XYChart<XYDataObject>(xyChartModel, ChartType.SCATTER);
        lineChart     = new XYChart<XYDataObject>(xyChartModel, ChartType.SMOOTH_AREA);
        areaChart     = new XYChart<XYDataObject>(xyChartModel, ChartType.AREA, Color.BLACK, Color.rgb(255, 0, 0, 0.5));

        yChartModel   = new YChartModel<YDataObject>(yData);
        donutChart    = new DonutChart<YDataObject>(yChartModel);
