...
class MyArgumentsOptimizationTestResponseSurfaceBlockFuelBlockTime{
...
public class Optimization_Test_ResponseSurface_BlockFuel_BlockTime  {
	...
	public static void main(String[] args) throws InvalidFormatException, HDF5LibraryException, ClassNotFoundException, IOException {
		...
		MyArgumentsOptimizationTestResponseSurfaceBlockFuelBlockTime va = new MyArgumentsOptimizationTestResponseSurfaceBlockFuelBlockTime();
		Optimization_Test_ResponseSurface_BlockFuel_BlockTime.theCmdLineParser = new CmdLineParser(va);
		MyConfiguration.initWorkingDirectoryTree();
		String outputPath = MyConfiguration.getDir(FoldersEnum.OUTPUT_DIR); 
		String subFolderPath = JPADStaticWriteUtils.createNewFolder(outputPath + "Optimization_Test_ResponseSurface_BlockFuel_BlockTime" + File.separator);
		
		try {
			Optimization_Test_ResponseSurface_BlockFuel_BlockTime.theCmdLineParser.parseArgument(args);
			...
			problem.setMaximizationProblemConditionArray(new boolean[] {false, false});
			problem.importResponseSurface(inputFilePath);
			problem.setVariablesLowerBounds(new double[] {20000.0,0.45});
			problem.setVariablesUpperBounds(new double[] {31000.0,0.64});
			...
			Optimization_Test_ResponseSurface_BlockFuel_BlockTime.theCmdLineParser.printUsage(System.err);
			System.err.println();
