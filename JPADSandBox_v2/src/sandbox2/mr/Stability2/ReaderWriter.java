...
public class ReaderWriter{
	...
	public void importFromXML(
		...
		//------------------LIFT AND MOMENT CURVE 3D

		theStabilityCalculator.setAlphaForClCurve(reader.readArrayofAmountFromXML("//treD_curves/lift/alpha"));
		theStabilityCalculator.setClInputCurve(reader.readArrayDoubleFromXMLSplit("//treD_curves/lift/lift_coefficient"));
		
		theStabilityCalculator.setAlphaForCmCurve(reader.readArrayofAmountFromXML("//treD_curves/moment/alpha_moment_curve"));
		theStabilityCalculator.setMomentInputCurve(reader.readArrayDoubleFromXMLSplit("//treD_curves/moment/cm_curve"));
		
		
		String tauInput = MyXMLReaderUtils
				.getXMLPropertyByPath(
						reader.getXmlDoc(), reader.getXpath(),
						"//@tau");
		if(tauInput.equalsIgnoreCase("INPUT")){
			theStabilityCalculator.setTauInput(MethodEnum.INPUT);
			theStabilityCalculator.set_tauIndex(Double.valueOf(reader.getXMLPropertyByPath("//operating_conditions/tau_index")));
		}
		if(tauInput.equalsIgnoreCase("SEMIEMPIRICAL"))
			theStabilityCalculator.setTauInput(MethodEnum.SEMPIEMPIRICAL);

		
		//--------INPUT 3D VALUES
		theStabilityCalculator.setDeltaCD0(Double.valueOf(reader.getXMLPropertyByPath("//operating_conditions/delta_CD0_flap")));
		theStabilityCalculator.setWingAlphaZeroLiftCONDITION((Amount<Angle>) reader.getXMLAmountWithUnitByPath("//treD_characteristics/alpha_zero_lift"));
		theStabilityCalculator.setWingalphaStarCONDITION((Amount<Angle>) reader.getXMLAmountWithUnitByPath("//treD_characteristics/alpha_star"));
		theStabilityCalculator.setWingalphaStallCONDITION((Amount<Angle>) reader.getXMLAmountWithUnitByPath("//treD_characteristics/alpha_stall"));
		theStabilityCalculator.setWingcLZeroCONDITION(Double.valueOf(reader.getXMLPropertyByPath("//treD_characteristics/cl_zero")));
		theStabilityCalculator.setWingcLMaxCONDITION(Double.valueOf(reader.getXMLPropertyByPath("//treD_characteristics/cl_max")));
		theStabilityCalculator.setWingcLStarCONDITION(Double.valueOf(reader.getXMLPropertyByPath("//treD_characteristics/cl_star")));
		theStabilityCalculator.setWingcLAlphaDegCONDITION(Double.valueOf(reader.getXMLPropertyByPath("//treD_characteristics/cl_alpha_deg")));
		theStabilityCalculator.setWingcLAlphaRadCONDITION(Double.valueOf(reader.getXMLPropertyByPath("//treD_characteristics/cl_alpha_rad")));
		theStabilityCalculator.setWingclAlphaCONDITION( Amount.valueOf(theStabilityCalculator.getWingcLAlphaDegCONDITION(), NonSI.DEGREE_ANGLE.inverse()));
