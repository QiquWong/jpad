...
class MyArgumentsDynamicStabilityTest {
...
public class DynamicStabilityTest {
	...
	public static void main(String[] args) throws InvalidFormatException, HDF5LibraryException {
		...
		MyArgumentsDynamicStabilityTest va = new MyArgumentsDynamicStabilityTest();
		DynamicStabilityTest.theCmdLineParser = new CmdLineParser(va);

		// populate the wing static object in the class-> start ...)
		try {
		// before launching the JavaFX application thread (launch -
			DynamicStabilityTest.theCmdLineParser.parseArgument(args);
			...
			DynamicStabilityTest.theCmdLineParser.printUsage(System.err);
			System.err.println();
