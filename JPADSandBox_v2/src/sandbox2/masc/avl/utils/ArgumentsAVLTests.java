package sandbox2.masc.avl.utils;
...
public class ArgumentsAVLTests { // see CompleteAnalysisTest
	@Option(name = "-aex", aliases = { "--avl-executable" }, required = false,
			usage = "path to AVL executable")
	private File _avlExecutableFile;

	@Option(name = "-abd", aliases = { "--avl-bin-dir" }, required = false,
			usage = "path to AVL bin directory")
	private File _avlBinDirPath;
	...
	public File getAvlBinDir() {
		return _avlBinDirPath;
	}
	
	public File getAvlExecutableFile() {
		return _avlExecutableFile;
	}
